const techniques = [
    {
        "id": "panorama",
        "name": "파노라마 토론",
        "concept": "한 사건을 여러 자리에서 나란히 보는 토론입니다. 세 명이 한 모둠을 이루어, 작품 속에서 서로 다른 가치를 대표하는 자리를 하나씩 맡습니다. 「완벽한 아이 팔아요」라면 아이에게 완벽함을 바라는 부모, 있는 그대로 사랑받고 싶은 아이, 아이를 상품으로 진열하는 마트가 됩니다. 각자 맡은 자리에서 왜 그럴 수밖에 없었는지 말하고, 서로를 꺾기 위해서가 아니라 더 알기 위해 질문을 주고받은 뒤, 마지막에는 모두가 함께 살아갈 방법을 찾습니다.",
        "easy": "세 명이 한 모둠이 되어 부모·아이·사회처럼 서로 다른 자리를 하나씩 맡고, 그 자리에 서서 같은 사건을 바라보며 이야기하는 토론이에요. 이기려는 토론이 아니라 서로를 알고 함께 살 길을 찾는 토론입니다.",
        "time": "80분 (2차시)",
        "prep": "역할 카드 세 장, 파노라마 실습 학습지, 세 명씩 마주 앉는 자리",
        "effect": "이기고 지는 토론이 아니라 서로를 이해하는 토론이 됩니다. 한쪽을 나쁜 편으로 몰지 않고, 사람뿐 아니라 그 사람을 그렇게 만든 사회까지 함께 보게 됩니다.",
        "tips": [
            "역할을 인물로만 채우지 마세요. 「완벽한 아이 팔아요」의 '마트'처럼 인물을 그렇게 만든 사회나 제도에도 한 자리를 주면 토론이 훨씬 깊어집니다.",
            "역할에 들어가기 전에 그 역할의 표정을 지어 보고 첫마디를 소리 내어 말해 보게 하면 금세 몰입합니다.",
            "교차 질의에서는 '상대를 꺾는 질문'이 아니라 '상대를 더 알고 싶은 질문'만 한다고 미리 못 박아 주세요.",
            "그림책 구석의 개미 떼나 굴러가는 돌멩이에게도 한 자리를 주면 아이들의 상상이 한결 자유로워집니다."
        ],
        "steps": [
            {
                "title": "질문으로 여백 채우기 (도입)",
                "desc": "그림책을 읽고 질문을 두 가지 만듭니다. 책에 답이 있는 '책 속 질문'과, 답이 나와 있지 않은 '책 밖 질문'입니다."
            },
            {
                "title": "역할 정하고 그 마음에 들어가기 (도입)",
                "desc": "세 명이 한 모둠이 되어 역할을 하나씩 맡고, 그 역할의 표정과 첫마디를 상상해 봅니다."
            },
            {
                "title": "1라운드 · 입장 말하기 (전개)",
                "desc": "'우리는 왜 이 자리를 지키는가'를 주장과 근거의 차례로 발표합니다."
            },
            {
                "title": "2라운드 · 서로 묻기 (전개)",
                "desc": "상대를 공격하지 않고, 상대 입장을 더 깊이 알기 위한 질문을 주고받습니다."
            },
            {
                "title": "3라운드 · 함께 살 길 찾기 (정리)",
                "desc": "각 입장에 그럴 만한 까닭이 있었음을 인정하고, 모두가 함께 살아갈 방법을 찾아 적습니다."
            }
        ],
        "books": [
            "완벽한 아이 팔아요",
        ...
        "teacherScenario": {
            "intro": "뒤프레 부부가 마트에서 완벽한 아이 바티스트를 사 왔다가, 받아쓰기 한 글자를 틀렸다고 물리러 갔지요. 오늘은 세 명이 한 모둠이 되어 이 일을 세 자리에서 볼 거예요. 완벽함을 바란 부모, 있는 그대로 사랑받고 싶은 아이, 아이를 상품으로 진열한 마트. 내가 맡은 자리에서 왜 그럴 수밖에 없었는지 이야기해 봅시다.",
            "wrapUp": "세 자리에서 나란히 보니, 주인공 한 사람만 보았을 때는 보이지 않던 사정이 드러났지요. 특히 '마트'라는 자리를 맡아 보니 아이를 성능으로 줄 세우는 것이 누구 한 사람의 잘못만은 아니라는 것도 보였습니다. 교실과 사회에서도 소리 내지 못하는 쪽의 자리에 서 보는 눈을 길러 갑시다."
        }
    },
    {
        "id": "valuebar",
        "name": "가치수직선 토론",
        "concept": "0(전혀 아니다)에서 10(정말 그렇다)까지 눈금을 바닥이나 칠판에 그려 놓고, 자기 생각과 맞는 자리에 직접 서거나 이름표를 붙이는 토론입니다. 왜 그 자리를 골랐는지 말하고, 친구 말을 듣고 생각이 움직이면 자리를 옮깁니다. 찬성과 반대 둘 중 하나가 아니라 그 사이 어디쯤이라고 말할 수 있는 것이 이 토론의 핵심입니다.",
        "easy": "바닥이나 칠판에 0~10 눈금을 그려 놓고, 내 생각이 얼마나 찬성(또는 반대)인지 그 위치에 직접 서 보는 토론이에요. 친구 말을 듣고 생각이 바뀌면 자리를 옮길 수 있어요.",
        "time": "40분 (1차시)",
        "prep": "바닥에 붙일 0~10 눈금 테이프, 학생별 이름표",
        "effect": "생각에는 찬성과 반대만 있는 것이 아니라 3쯤, 7쯤 같은 자리도 있다는 것을 몸으로 알게 됩니다. 자리를 옮기는 일이 부끄러운 일이 아니라는 것도 함께 배웁니다.",
        "tips": [
            "양 끝에 선 학생과 가운데 선 학생을 번갈아 물어보면 생각의 차이가 또렷하게 드러납니다.",
            "직접 걸어가 서게 하거나 이름이 적힌 자석을 칠판에 붙이게 하면 참여가 훨씬 활발해집니다."
        ],
        "steps": [
            {
                "title": "내 자리 고르기 (도입)",
                "desc": "논제를 듣고 0~10 가운데 내 생각과 맞는 자리에 서서, 그 자리를 고른 까닭을 적습니다."
            },
            {
                "title": "멀리 선 친구와 이야기하기 (전개)",
                "desc": "숫자가 많이 차이 나는 친구를 만나 서로 그 자리에 선 까닭을 듣고 견줍니다."
            },
            {
                "title": "생각이 움직이면 자리 옮기기 (전개)",
                "desc": "친구 말이 그럴듯하면 자리를 옮기고, 무엇이 마음을 움직였는지 적습니다."
            },
            {
                "title": "생각의 자리 돌아보기 (정리)",
                "desc": "처음 자리와 마지막 자리를 견주며 서로 다른 생각이 어떻게 만날 수 있었는지 적습니다."
            }
        ],
        "books": [
            "밴드 브레멘",
        ...
        "teacherScenario": {
            "intro": "늙고 다쳤다는 이유로 주인에게 버림받은 동물들이 음악으로 함께 서며 자기 가치를 증명합니다. '쓸모만으로 가치를 매긴 주인들의 결정은 옳은가?' 이 질문에 대해, 바닥에 그려진 0에서 10까지의 눈금 가운데 내 생각과 맞는 자리에 서 봅시다.",
            "wrapUp": "가운데 서 있던 친구의 말을 듣고 자리를 옮긴 친구가 있네요. 그것이 바로 이 토론의 핵심입니다. 내 생각을 끝까지 우기는 것이 아니라, 친구의 말에 그럴 만한 까닭이 있으면 언제든 자리를 옮길 수 있다는 것을 오늘 몸으로 배웠습니다."
        }
    },
    {
        "id": "brainwriting",
        "name": "브레인라이팅 (Brainwriting)",
        "concept": "말하지 않고 종이에 적는 토론입니다. 먼저 자기 생각을 한 칸에 적고, 정해진 시간이 되면 옆 사람에게 종이를 넘깁니다. 넘겨받은 사람은 앞사람 생각을 읽고 그 아래에 보탤 말을 적습니다. 말이 빠른 몇 사람이 이야기를 끌고 가는 일이 없어 모두의 생각이 종이에 고르게 남습니다.",
        "easy": "말하지 않고 종이에 생각을 적은 뒤 옆 사람에게 돌려, 친구 아이디어에 내 생각을 덧붙여 가는 '조용한 토론'이에요. 발표가 부끄러운 친구도 편하게 참여할 수 있어요.",
        "time": "40분 (1차시)",
        "prep": "그림책, 칸이 나뉜 활동지, 모둠별 필기도구",
        "effect": "여러 사람의 생각이 겹겹이 쌓여 혼자서는 떠올리기 어려운 해결책이 나옵니다. 남 앞에서 말하기를 어려워하는 학생도 부담 없이 똑같이 참여할 수 있습니다.",
        "tips": [
            "맨 처음 적는 생각이 또렷해야 다음 사람이 살을 붙이기 좋습니다.",
            "말하지 않기로 한 약속을 지키게 하면 친구 생각을 조용히 읽고 곱씹을 시간이 생깁니다.",
            "적힌 생각을 깎아내리지 않고 보태기만 하도록 합니다. 고쳐 주고 싶을 때도 '이렇게 하면 어떨까'로 적게 하세요."
        ],
        "steps": [
            {
                "title": "문제 확인하고 첫 생각 적기 (도입)",
                "desc": "그림책 속 갈등이나 풀어야 할 문제를 확인하고, 첫 칸에 내 해결책을 말없이 적습니다."
            },
            {
                "title": "옆으로 넘기며 보태기 (전개)",
                "desc": "시간이 되면 종이를 옆 사람에게 넘기고, 받은 종이에는 앞사람 생각에 보탤 말을 적습니다."
            },
            {
                "title": "모아서 고르기 (정리)",
                "desc": "종이가 한 바퀴 돌아오면 쌓인 생각 가운데 가장 좋은 것을 모둠이 골라 학급에 알립니다."
            }
        ],
        "books": [
            "슈퍼 거북",
        ...
        "teacherScenario": {
            "intro": "토끼를 이긴 뒤 빠른 삶에 자신을 억지로 맞추느라 지쳐 버린 거북이 꾸물이의 이야기를 읽었습니다. '남의 눈과 세상의 기준에 나를 맞추며 살 때 생기는 문제와 그 해결책'에 대해, 말 대신 종이에 조용히 적고 옆 친구에게 넘겨 생각을 쌓아 봅시다.",
            "wrapUp": "말하기가 부끄러웠던 친구들도 종이 위에서는 자기 생각을 또렷이 내놓았고, 그 위에 다른 친구의 생각이 겹겹이 쌓여 훌륭한 해결책이 되었습니다. 떠들썩한 토론만 토론이 아닙니다. 조용히 적어 내려간 글이 더 넓은 생각을 열어 주기도 합니다."
        }
    },
    {
        "id": "procon",
        "name": "프로콘 (Pro-Con) 토론",
        "concept": "한 논제를 두고 찬성과 반대를 모두 맡아 보는 토론입니다. 먼저 정해진 편에서 토론하고, 신호가 울리면 편을 바꿔 조금 전까지 상대가 하던 주장을 이번에는 내가 펼칩니다. 반대편에 서 보면 그쪽 말에도 나름의 까닭이 있다는 것을 알게 됩니다.",
        "easy": "찬성과 반대를 한 번씩 모두 맡아 보는 토론이에요. 내가 반대했던 입장도 직접 말해 보면 '양쪽 다 일리가 있구나'를 느끼게 됩니다.",
        "time": "40분 ~ 80분 (1~2차시)",
        "prep": "그림책, 주장·반박 기록지, 타이머, 신호용 종",
        "effect": "'우리가 옳고 저쪽이 틀렸다'는 생각에서 벗어납니다. 내가 반대하던 주장까지 직접 말해 보면서 한 가지 일을 여러 쪽에서 보는 힘이 자랍니다.",
        "tips": [
            "편을 바꾸는 순간에는 종소리처럼 분명한 신호를 주세요. 생각을 통째로 갈아타야 하기 때문입니다.",
            "양쪽을 다 겪은 뒤에 '그래서 우리는 이렇게 하자'는 절충안을 만들어 보면 배움이 훨씬 깊어집니다."
        ],
        "steps": [
            {
                "title": "편 나누고 근거 세우기 (도입)",
                "desc": "모둠을 반씩 찬성과 반대로 나누고, 각자 맡은 편의 근거를 정리합니다."
            },
            {
                "title": "첫 번째 토론 (전개)",
                "desc": "맡은 편에서 주장을 펼치고 상대 주장에 반박합니다."
            },
            {
                "title": "편 바꿔 두 번째 토론 (전개)",
                "desc": "신호에 맞춰 찬성과 반대를 맞바꾸고, 조금 전 상대가 하던 주장을 이번에는 내가 지킵니다."
            },
            {
                "title": "양쪽을 겪고 정리하기 (정리)",
                "desc": "어느 한쪽으로 기울지 않게 양쪽 주장의 타당한 점을 나란히 적어 정리합니다."
            }
        ],
        "books": [
            "지각대장 존",
        ...
        "teacherScenario": {
            "intro": "소문과 의심으로 친구를 하나씩 내쫓다가 끝내 모두가 무너지는 「감기 걸린 물고기」를 읽었습니다. '모두를 지키기 위해 의심스러운 친구를 미리 내보내는 것은 옳은가?' 찬성과 반대로 나누어 토론하고, 신호가 울리면 편을 바꿔 한 번 더 하겠습니다.",
            "wrapUp": "편을 바꿔 말해 보니, 조금 전까지 내가 반박하던 쪽에도 나름의 까닭이 있었지요. 소문의 위험과 공동체의 안전이 어디서 부딪치는지 또렷해졌습니다. 상대를 꺾는 데서 멈추지 않고 함께 다른 길을 찾아본 것이 오늘의 가장 큰 수확입니다."
        }
    },
    {
        "id": "hotseating",
        "name": "핫시팅 (Hot-seating)",
        "concept": "한 학생이 책 속 인물이 되어 가운데 놓인 '뜨거운 의자'에 앉고, 나머지 학생들이 그 인물에게 질문을 던지는 토론입니다. 의자에 앉은 학생은 인물의 입장에서 그 자리에서 바로 답합니다. 왜 그런 선택을 했는지 본인의 입으로 듣다 보면 겉으로 드러난 행동 뒤의 사정이 보입니다.",
        "easy": "한 친구가 책 속 인물이 되어 '뜨거운 의자'에 앉고, 나머지 친구들이 그 인물에게 궁금한 점을 질문하는 역할극 토론이에요. 인물의 속마음을 깊이 이해할 수 있어요.",
        "time": "40분 (1차시)",
        "prep": "가운데 놓을 의자, 인물 소품(왕관·스카프 등), 질문 카드",
        "effect": "인물의 마음에 가까이 다가가게 됩니다. 행동만 보고 판단하던 데에서 나아가 그 사람이 놓인 형편까지 헤아리게 됩니다.",
        "tips": [
            "의자에 앉은 학생이 막힐 때는 교사가 '마음속 목소리'가 되어 한마디 거들어 주면 부담이 줄어듭니다.",
            "안경이나 지팡이처럼 인물을 떠올리게 하는 작은 소품 하나면 훨씬 깊이 빠져듭니다."
        ],
        "steps": [
            {
                "title": "인물 정하고 의자 놓기 (도입)",
                "desc": "가운데에 의자를 놓고, 질문을 받을 인물을 맡은 학생이 그 자리에 앉습니다."
            },
            {
                "title": "질문 던지기 (전개)",
                "desc": "나머지 학생들은 책 내용을 근거로 인물이 왜 그렇게 했는지 묻습니다."
            },
            {
                "title": "인물이 되어 답하고 바꿔 앉기 (정리)",
                "desc": "인물의 입장에서 답하고, 다른 인물이나 다른 학생으로 바꿔 가며 이어 갑니다."
            },
            {
                "title": "인물에게 편지 쓰기 (정리)",
                "desc": "속사정을 알게 된 뒤 그 인물에게 건네고 싶은 말을 편지로 적습니다."
            }
        ],
        "books": [
            "돼지책",
        ...
        "teacherScenario": {
            "intro": "말을 더듬어 발표가 두려웠던 아이의 마음을 함께 읽었습니다. 이제 모둠마다 그 아이 역할을 맡은 친구가 가운데 '뜨거운 의자'에 앉습니다. 나머지 친구들은 예의를 갖춰 묻고, 의자에 앉은 친구는 그 아이가 되어 답해 주세요.",
            "wrapUp": "의자에 앉은 친구의 조심스러운 답을 들으며, 우리가 대수롭지 않게 넘겼던 침묵이 얼마나 무거운 말이었는지 알게 되었습니다. 남의 자리에 잠깐 앉아 보는 것, 그것이 이해의 첫걸음입니다."
        }
    },
    {
        "id": "carousel",
        "name": "회전목마 토론 (Carousel)",
        "concept": "안쪽 원과 바깥쪽 원으로 마주 보고 앉아 짝과 짧게 토론한 뒤, 신호가 울리면 바깥쪽 학생들이 한 칸씩 옮겨 새 짝을 만나는 토론입니다. 같은 논제로 여러 사람과 거듭 이야기하다 보면, 앞선 짝에게 들은 반박을 다음 짝에게는 미리 막을 수 있게 됩니다.",
        "easy": "두 겹의 원으로 마주 앉아 1:1로 짧게 이야기한 뒤, 신호에 맞춰 자리를 옮겨 새로운 짝과 같은 주제로 또 이야기하는 토론이에요. 여러 친구를 만나며 내 생각이 점점 단단해져요.",
        "time": "40분 ~ 80분 (1~2차시)",
        "prep": "두 겹 원으로 앉을 수 있는 공간, 타이머, 신호용 종",
        "effect": "짧은 시간에 여러 사람의 생각을 만납니다. 같은 말을 되풀이하는 동안 내 주장에서 약한 곳이 어디인지 스스로 알게 되고 말이 점점 다듬어집니다.",
        "tips": [
            "한 짝과 이야기하는 시간이 길어지면 지루해집니다. 한 차례를 2~3분으로 짧게 끊어 주세요.",
            "자리를 옮길수록 '앞 짝에게 들은 좋은 생각'을 가져와 내 주장에 보태도록 이끌어 주세요.",
            "자리를 옮길 때마다 찬성과 반대를 서로 바꿔 맡게 하면 한 논제를 양쪽에서 모두 겪어 보게 됩니다.",
            "교실 안에서 이동이 생기므로 '신호가 울리면 바깥쪽 원만, 한 칸씩'처럼 약속을 먼저 정해 두세요."
        ],
        "steps": [
            {
                "title": "두 겹 원으로 앉아 첫 토론 (도입)",
                "desc": "안쪽 원은 찬성, 바깥쪽 원은 반대로 마주 앉아 짝과 토론을 시작합니다."
            },
            {
                "title": "신호에 맞춰 짝 바꾸기 (전개)",
                "desc": "신호가 울리면 바깥쪽 학생만 한 칸 옮겨 새 짝을 만나고, 같은 논제로 다시 토론합니다."
            },
            {
                "title": "들은 반박을 내 말에 보태기 (정리)",
                "desc": "앞선 짝에게 들은 반박과 그것을 막아 낸 방법을 내 주장에 덧붙입니다."
            },
            {
                "title": "마지막 내 주장 쓰기 (정리)",
                "desc": "여러 번의 대화를 거쳐 다듬어진 마지막 주장을 차례에 맞게 적습니다."
            }
        ],
        "books": [
            "스갱 아저씨의 염소",
        ...
        "teacherScenario": {
            "intro": "성격이 정반대인 남매가 다투지만 위기에서 서로를 구하는 「터널」을 읽었습니다. 안쪽 원과 바깥쪽 원으로 마주 앉아 주세요. '형제자매의 다툼은 사이를 망치기보다 서로를 더 알게 한다'를 두고 짝과 짧게 토론하고, 신호가 울리면 바깥쪽 원만 한 칸씩 옮겨 새 짝과 이어 갑니다.",
            "wrapUp": "짝이 바뀔 때마다 같은 말을 되풀이하면서, 앞 짝에게 들은 반박을 다음 짝에게는 미리 막아 냈지요. 여러 사람을 만나는 동안 내 말이 저절로 다듬어졌습니다."
        }
    },
    {
        "id": "socratic",
        "name": "소크라틱 세미나",
        "concept": "정답이 하나로 정해지지 않은 질문을 만들어, 둥글게 앉아 서로 묻고 답하는 토론입니다. 손을 들지 않고 앞사람 말이 끝나면 하고 싶은 사람이 이어 말합니다. 이기고 지는 것이 없으며, 책의 한 문장이나 한 장면을 근거로 삼아 함께 뜻을 찾아 갑니다. 소크라테스가 묻고 답하며 가르치던 방식에서 왔습니다.",
        "easy": "정답이 없는 질문을 만들어, 둥글게 앉아 서로 묻고 답하며 책의 깊은 의미를 함께 찾는 토론이에요. 이기는 게 아니라 같이 이해하는 것이 목표예요.",
        "time": "80분 (2차시)",
        "prep": "토론 약속 안내장, 관찰 기록지, 둥근 자리 배치",
        "effect": "다투지 않고도 깊이 들어갈 수 있다는 것을 겪게 됩니다. 책을 꼼꼼히 읽는 힘과 끝까지 듣고 말을 받는 태도가 함께 자랍니다.",
        "tips": [
            "손을 들어 발표하는 방식을 내려놓으세요. 잠시 말이 끊겨도 기다려 주면 아이들이 스스로 말을 잇기 시작합니다.",
            "'몇 쪽에 이렇게 나와 있어서'처럼 책을 짚으며 말하는 연습을 거듭하게 하세요."
        ],
        "steps": [
            {
                "title": "정답 없는 질문 만들기 (도입)",
                "desc": "그림책을 읽고 삶과 이어지는 열린 질문을 각자 하나씩 만듭니다."
            },
            {
                "title": "둥글게 앉아 이야기하기 (전개)",
                "desc": "말하는 모둠과 지켜보는 모둠으로 나눠 앉고, 손을 들지 않고 앞사람 말을 이어 갑니다."
            },
            {
                "title": "지켜본 것 돌려주고 자리 바꾸기 (전개)",
                "desc": "지켜본 모둠이 대화 태도에 대해 본 것을 전하고, 역할을 바꿔 한 번 더 합니다."
            },
            {
                "title": "남은 생각 적기 (정리)",
                "desc": "오늘 들은 말 가운데 마음에 남은 것을 골라 내 생각을 글로 정리합니다."
            }
        ],
        "books": [
            "까마귀 소년",
        ...
        "teacherScenario": {
            "intro": "홀로 지내시는 할머니의 여가를 자녀가 꼭 챙겨 드려야 하는지를 이야기해 봅시다. 오늘 선생님은 발언 순서를 정하지 않고 듣기만 하겠습니다. 둥글게 앉아 책 속 할머니의 표정과 물건을 근거로 짚으며, 묻고 답하기를 이어 가 주세요.",
            "wrapUp": "선생님이 끼어들지 않아도 끝까지 듣고 그 말에 이어 묻는 대화가 오래 이어졌습니다. 이기고 지는 것 없이도 이야기가 이만큼 깊어질 수 있다는 것을 오늘 확인했습니다."
        }
    },
    {
        "id": "worldcafe",
        "name": "월드카페 (World Cafe)",
        "concept": "테이블마다 다른 질문을 놓고 카페에서 이야기하듯 편하게 나누는 토론입니다. 한 차례가 끝나면 테이블 주인 한 명만 남고 나머지는 다른 테이블로 옮겨 갑니다. 주인은 앞사람들이 나눈 이야기를 새로 온 손님에게 들려주고, 손님들은 그 위에 자기 생각을 보탭니다.",
        "easy": "카페처럼 편안한 분위기에서 테이블마다 다른 질문을 두고 이야기하다가, 한 명만 남고 나머지는 다른 테이블로 옮겨 다니며 아이디어를 섞는 토론이에요.",
        "time": "80분 (2차시)",
        "prep": "잔잔한 음악, 모둠별 큰 종이, 색 마커, 자리 주인 팻말",
        "effect": "생각이 테이블을 건너다니며 섞입니다. 한 모둠에 머물렀다면 나오지 않았을 해결책이 나오고, 누가 더 잘났는지를 따지지 않는 분위기가 만들어집니다.",
        "tips": [
            "잔잔한 음악과 마실 것을 준비하면 긴장이 풀려 말이 훨씬 부드럽게 오갑니다.",
            "글씨를 반듯하게 쓰라고 하지 마세요. 그림과 낙서로 어지럽게 적을수록 생각이 잘 굴러갑니다."
        ],
        "steps": [
            {
                "title": "테이블마다 질문 놓고 주인 정하기 (도입)",
                "desc": "테이블마다 다른 질문을 놓고, 자리를 지킬 주인 한 명을 정한 뒤 큰 종이를 펼칩니다."
            },
            {
                "title": "낙서하듯 이야기 적기 (전개)",
                "desc": "큰 종이에 그림과 낱말로 마음껏 적어 가며 이야기합니다."
            },
            {
                "title": "손님은 옮기고 주인은 남기 (전개)",
                "desc": "주인만 남고 나머지는 다른 테이블로 옮겨, 앞사람 이야기를 듣고 자기 생각을 보탭니다."
            },
            {
                "title": "돌아와 마무리하고 둘러보기 (정리)",
                "desc": "원래 자리로 돌아와 종이를 정리하고, 교실을 돌며 다른 테이블의 종이를 읽습니다."
            }
        ],
        "books": [
            "알사탕",
        ...
        "teacherScenario": {
            "intro": "땅은 사고팔 수 없다고 말한 추장의 편지를 읽고, 자연과 사람의 권리를 이야기해 봅시다. 테이블마다 다른 질문이 놓여 있습니다. 큰 종이에 낙서하듯 편하게 적으며 이야기하다가, 종이 울리면 테이블 주인만 남고 나머지는 다른 테이블로 옮겨 갑니다.",
            "wrapUp": "여러 테이블을 옮겨 다니며 모은 생각 조각들이 한 장의 종이 위에 그림처럼 모였습니다. 생각은 혼자 쥐고 있을 때보다 카페에서 이야기하듯 편하게 나눌 때 더 크게 자랍니다."
        }
    },
    {
        "id": "argumentgame",
        "name": "논증 게임 (Argumentation Game)",
        "concept": "'나는 ~라고 생각해(주장) / 왜냐하면 ~(이유) / 예를 들면 ~(근거)' 이 세 마디를 보드게임처럼 놀며 익히는 토론입니다. 주사위를 굴려 말을 옮기고, 걸린 칸의 질문에 세 마디를 갖춰 말해야 지나갈 수 있습니다.",
        "easy": "'나는 ~라고 생각해(주장) + 왜냐하면 ~(이유) + 예를 들면 ~(근거)' 형식을 보드게임처럼 즐기며 익히는 토론이에요. 놀이로 조리 있게 말하는 힘을 길러요.",
        "time": "40분 (1차시)",
        "prep": "논증 게임 말판, 주장·이유·근거 카드, 말, 주사위",
        "effect": "토론이 무섭다고 느끼는 어린 학생도 놀이로 시작할 수 있습니다. 생각을 차례에 맞게 말하는 틀이 몸에 익습니다.",
        "tips": [
            "처음에는 주장이 맞았는지 따지지 말고, 세 마디 틀만 갖추면 무조건 칭찬하고 토큰을 주세요. 자신감이 먼저입니다.",
            "근거가 억지스러워도 곧바로 반박하지 말고 '그럼 책의 어느 장면과 이어질까?'라고 물어 자연스럽게 고쳐 주세요."
        ],
        "steps": [
            {
                "title": "말하기 틀 익히기 (도입)",
                "desc": "'나는 ~라고 생각해 / 왜냐하면 ~ / 예를 들면 ~' 세 마디를 함께 소리 내어 연습합니다."
            },
            {
                "title": "주사위 굴리고 말하기 (전개)",
                "desc": "말을 옮기다 걸린 질문 칸에서 세 마디를 갖춰 말해야 지나갈 수 있습니다."
            },
            {
                "title": "친구들이 듣고 점수 주기 (전개)",
                "desc": "모둠 친구들이 듣고 세 마디가 갖춰졌다고 인정하면 토큰을 줍니다. 모자라면 질문으로 도와줍니다."
            },
            {
                "title": "잘된 말 적어 두기 (정리)",
                "desc": "오늘 가장 잘 말해진 세 마디를 활동지에 적어 둡니다."
            }
        ],
        "books": [
            "완벽한 아이 팔아요"
        ...
        "teacherScenario": {
            "intro": "자기 가치를 증명하려 애쓰는 암탉의 모험을 읽었습니다. 주사위를 굴려 질문 칸에 걸리면 '나는 ~라고 생각해 / 왜냐하면 ~ / 예를 들면 ~' 세 마디를 갖춰 말해야 지나갈 수 있습니다. 모둠 친구들은 그 말이 세 마디를 갖췄는지 들어 주고 토큰을 건네 주세요.",
            "wrapUp": "무작정 우기는 대신 '왜냐하면'으로 까닭을 붙이고, 책 속 장면을 '예를 들면'으로 가져오는 말하기가 몸에 붙었습니다. 놀이처럼 했지만 그 안에 토론의 뼈대가 단단히 들어 있었습니다."
        }
    },
    {
        "id": "trafficlight",
        "name": "신호등 토론 (Traffic Light)",
        "concept": "찬성이면 초록, 반대면 빨강, 아직 못 정했으면 노랑 카드를 들어 생각을 한눈에 보여 주는 토론입니다. 이야기를 듣다 생각이 바뀌면 언제든 카드 색을 바꿀 수 있고, 왜 바꿨는지 말하는 것이 이 토론의 중심입니다.",
        "easy": "찬성은 초록, 반대는 빨강, 중립은 노랑 카드를 들어 내 생각을 한눈에 보여주는 토론이에요. 이야기를 듣다 생각이 바뀌면 카드 색을 바꿀 수 있어요.",
        "time": "40분 (1차시)",
        "prep": "신호등 카드 세트(학생마다 세 색 한 장씩), 카드 기록 활동지",
        "effect": "생각이 바뀌는 일을 '지는 것'이 아니라 '잘 들은 것'으로 여기게 됩니다. 남의 말에 귀를 열어 두는 태도가 자랍니다.",
        "tips": [
            "카드를 바꾼 학생을 나무라지 말고 '누구의 어떤 말이 마음을 움직였니?'라고 물으며 크게 칭찬해 주세요.",
            "노란 카드를 든 학생에게는 우유부단하다고 하지 말고, 양쪽 말을 저울질해 보는 '판정단' 역할을 잠시 맡겨 보세요."
        ],
        "steps": [
            {
                "title": "카드 들어 첫 생각 보이기 (도입)",
                "desc": "인물의 선택에 대해 초록·빨강·노랑 가운데 하나를 들어 지금 생각을 보여 줍니다."
            },
            {
                "title": "색깔끼리, 색깔 건너 이야기하기 (전개)",
                "desc": "같은 색끼리 까닭을 말하고, 노란 카드를 든 학생이 양쪽에 궁금한 것을 묻습니다."
            },
            {
                "title": "생각이 바뀌면 카드 바꾸기 (전개)",
                "desc": "듣다가 생각이 움직이면 언제든 카드를 바꾸고, 무엇이 마음을 움직였는지 말합니다."
            },
            {
                "title": "생각이 지나온 길 적기 (정리)",
                "desc": "처음 든 색과 마지막에 든 색을 견주며 생각이 어떻게 달라졌는지 적습니다."
            }
        ],
        "books": [
            "세 강도",
        ...
        "teacherScenario": {
            "intro": "훔친 보물로 아이들을 돌본 세 강도의 행동은 옳을까요? 찬성은 초록, 반대는 빨강, 아직 못 정했으면 노랑 카드를 머리 위로 들어 지금 생각을 보여 주세요. 친구들의 말을 듣다가 생각이 바뀌면 언제든 카드를 바꿔도 좋습니다.",
            "wrapUp": "'좋은 목적과 옳은 방법이 부딪쳐서 생각이 흔들렸다'며 노란 카드로 바꾼 친구들의 말이 오래 남습니다. 신호등 불빛이 바뀌듯, 남의 말을 듣고 내 생각을 고쳐 보는 일이 토론에서 가장 값진 순간입니다."
        }
    },
    {
        "id": "pmi",
        "name": "PMI 토론",
        "concept": "하나의 일을 좋은 점(P), 아쉬운 점(M), 흥미로운 점(I) 세 칸으로 나눠 차례대로 살펴보는 방법입니다. 좋고 싫음을 먼저 정해 놓고 이유를 찾는 대신, 세 칸을 차례로 채우며 한쪽으로 치우치지 않게 살핍니다. 영국의 에드워드 드 보노가 만든 생각 정리법입니다.",
        "easy": "어떤 일을 좋은 점(P), 아쉬운 점(M), 흥미로운 점(I) 세 가지로 나눠 차분히 따져 보는 토론이에요. 감정으로 싸우지 않고 골고루 살펴보게 돼요.",
        "time": "40분 (1차시)",
        "prep": "세 칸으로 나뉜 활동지, 모둠별 큰 종이",
        "effect": "좋다 싫다부터 튀어나오는 버릇을 잠시 미뤄 두게 됩니다. 찬성과 반대 어느 쪽도 서둘러 정하지 않고 한 가지 일의 여러 면을 고르게 보는 힘이 자랍니다.",
        "tips": [
            "좋은 점과 아쉬운 점은 잘 찾지만 흥미로운 점을 어려워합니다. '이걸 다른 데에 써 본다면?', '뜻밖에 따라오는 일은?'이라고 물어 주세요.",
            "비판을 좋아하는 학생에게 일부러 좋은 점을 적게 하면 생각의 폭이 넓어집니다."
        ],
        "steps": [
            {
                "title": "세 칸 채우기 (도입)",
                "desc": "사건을 확인하고 좋은 점(P), 아쉬운 점(M), 흥미로운 점(I)을 활동지 세 칸에 적습니다."
            },
            {
                "title": "모둠끼리 모아 보기 (전개)",
                "desc": "각자 적은 것을 큰 종이에 모으며 내가 못 본 문제점이나 기발한 생각을 확인합니다."
            },
            {
                "title": "해결책 만들기 (정리)",
                "desc": "아쉬운 점은 줄이고 흥미로운 점은 살릴 수 있는 새 방법을 모둠이 함께 만듭니다."
            },
            {
                "title": "발표하고 다듬기 (정리)",
                "desc": "모둠이 만든 방법을 발표하고, 다른 모둠의 의견을 들어 다듬습니다."
            }
        ],
        "books": [
            "나는 사실대로 말했을 뿐이야!",
        ...
        "teacherScenario": {
            "intro": "집안일을 누가 얼마나 맡아야 하는지에 대한 이야기입니다. 오늘은 좋다 싫다로 다투지 않고 세 칸으로 나눠 볼 거예요. 먼저 좋은 점(P), 다음으로 아쉬운 점(M), 마지막으로 재미있게 바꿔 볼 점(I)을 차례대로 붙임쪽지에 적어 봅시다.",
            "wrapUp": "찬성과 반대로 갈라서는 대신 세 칸을 차례로 채우다 보니, 집안일에 점수를 매겨 보자는 새로운 생각까지 나왔습니다. 좋고 싫음을 잠시 미뤄 두면 이렇게 다른 길이 보입니다."
        }
    },
    {
        "id": "2stay2stray",
        "name": "둘 가고 둘 남기 (2 Stay 2 Stray)",
        "concept": "모둠 네 명 가운데 두 명은 자리에 남아 우리 모둠 생각을 설명하고, 두 명은 다른 모둠을 찾아다니며 듣고 적어 오는 방식입니다. 돌아온 뒤에는 들고 온 생각을 우리 모둠 종이에 보태 완성합니다. 협동학습에서 오래 쓰여 온 모둠 나누기 방법입니다.",
        "easy": "모둠 4명 중 2명은 남아서 설명하고, 2명은 다른 모둠을 돌아다니며 아이디어를 모아 오는 토론이에요. 교실 전체의 생각을 나눌 수 있어요.",
        "time": "40분 (1차시)",
        "prep": "모둠별 큰 종이, 마커펜, 다니며 적을 메모장",
        "effect": "우리 모둠 안에서만 맴돌지 않고 교실 전체의 생각을 나눠 가집니다. 남아서 설명하는 학생은 설명하는 동안 자기가 무엇을 아는지 또렷해집니다.",
        "tips": [
            "한 차례가 끝나면 남는 역할과 다니는 역할을 꼭 바꾸세요. 설명하는 책임과 돌아다니는 재미를 모두가 겪어야 합니다.",
            "다녀온 학생이 돌아온 뒤 우리 종이를 고칠 시간을 넉넉히 주는 것이 가장 중요합니다."
        ],
        "steps": [
            {
                "title": "모둠 생각 큰 종이에 정리하기 (도입)",
                "desc": "그림책 주제로 모둠에서 나눈 결론을 큰 종이에 보기 쉽게 적습니다."
            },
            {
                "title": "둘은 떠나고 둘은 남기 (전개)",
                "desc": "두 명은 다른 모둠으로 가고, 남은 두 명은 자리에서 손님을 맞습니다."
            },
            {
                "title": "설명하고 받아 적기 (전개)",
                "desc": "남은 사람은 우리 종이를 설명하고, 찾아간 사람은 좋은 생각을 적어 옵니다. 두세 번 돌아갑니다."
            },
            {
                "title": "돌아와 우리 종이 채우기 (정리)",
                "desc": "모아 온 생각을 들고 원래 모둠으로 돌아와 우리 종이에 보태 마무리합니다."
            }
        ],
        "books": [
            "꽃을 선물할게",
        ...
        "teacherScenario": {
            "intro": "먹이사슬의 규칙과 애벌레를 살리려는 마음이 부딪치는 이야기입니다. 모둠에서 정리한 해결책을 두고, 두 명은 자리에 남아 설명하고 두 명은 다른 모둠을 찾아다니며 들어 봅시다. 돌아와서는 남아 있던 생각과 들고 온 생각을 합쳐 마무리합니다.",
            "wrapUp": "한쪽이 새 생각을 모아 오는 동안 다른 한쪽은 자리를 지키며 우리 모둠 생각을 충실히 설명해 주었습니다. 설명해 본 사람과 들으러 간 사람이 모여, 혼자서는 떠올리지 못했을 답을 만들었습니다."
        }
    },
    {
        "id": "fan",
        "name": "선풍기 토론",
        "concept": "둥글게 앉아 차례대로 말하되, 말하기 전에 앞사람 말을 한 줄로 요약하고 시작하는 토론입니다. '네 말은 ~라는 뜻이지. 나는 여기에 ~을 보태고 싶어'처럼 이어 갑니다. 선풍기 날개가 돌듯 차례가 돌아가는 동안, 듣지 않으면 말할 수 없는 구조가 됩니다.",
        "easy": "앞사람 말을 한 줄로 요약한 뒤 내 생각을 덧붙여 차례차례 이어 가는 토론이에요. 선풍기 날개처럼 돌아가며 '잘 듣기'를 훈련해요.",
        "time": "40분 (1차시)",
        "prep": "말하기 약속 안내판, 초시계, 차례를 넘길 물건(모형 마이크 등)",
        "effect": "내 차례에 말하려면 앞사람 말을 반드시 들어야 하므로 딴생각할 틈이 줄어듭니다. 듣고 요약하는 일이 습관이 됩니다.",
        "tips": [
            "요약 15초, 내 의견 30초처럼 시간을 정해 두면 차례가 빠르게 돌아 지루하지 않습니다.",
            "요약을 제대로 못 했다고 바로 넘기지 말고, 앞사람이 한 번 더 말해 줄 기회를 주세요."
        ],
        "steps": [
            {
                "title": "둥글게 앉아 약속 정하기 (도입)",
                "desc": "모둠 4~6명이 둥글게 앉아, 앞사람 말을 요약하고 시작한다는 약속을 확인합니다."
            },
            {
                "title": "요약하고 이어 말하기 (전개)",
                "desc": "'네 말은 ~라는 뜻이지. 나는 ~을 보태고 싶어'의 틀을 지키며 차례대로 말합니다."
            },
            {
                "title": "생각이 눈덩이처럼 불어나기 (정리)",
                "desc": "서너 바퀴 도는 동안 쌓인 말들이 모둠 하나의 생각으로 모입니다."
            },
            {
                "title": "모둠 결론 적기 (정리)",
                "desc": "모두가 동의한 마지막 해결책을 활동지에 적습니다."
            }
        ],
        "books": [
            "원숭이 꽃신"
        ...
        "teacherScenario": {
            "intro": "학교와 친구들 사이에서 밀려나 있던 아이가 자기 재능으로 인정받는 이야기입니다. 1번 친구가 말하면, 2번 친구는 그 말을 한 줄로 요약한 뒤 자기 생각을 보탭니다. 3번도 앞사람 말을 받아 이어 가는 식으로, 선풍기 날개가 돌듯 차례를 돌리겠습니다.",
            "wrapUp": "내 말 할 생각에 앞사람 말을 흘려듣던 버릇에서 벗어나, 정확히 요약하고 받은 뒤에 내 생각을 얹었습니다. 서로의 말이 날개처럼 맞물려 돌아갈 때 비로소 제대로 듣는 일이 일어납니다."
        }
    },
    {
        "id": "reasoning",
        "name": "이유찾기 토론",
        "concept": "'주인공은 왜 하필 그렇게 했을까?' 납득하기 어려운 선택 하나를 칠판에 적어 놓고, 그 까닭을 책 속에서 찾아내는 토론입니다. 문장 사이에 숨은 뜻과 그림 구석의 단서를 증거로 모아, 탐정이 사건을 풀듯 '그래서 그랬을 것이다'를 밝혀냅니다.",
        "easy": "'주인공은 왜 그런 뜻밖의 선택을 했을까?'를 탐정처럼 책 속 단서를 찾아 증명하는 토론이에요. 그림과 문장 속 힌트가 모두 증거가 됩니다.",
        "time": "40분 (1차시)",
        "prep": "증거를 붙일 판, 붙임쪽지, 돋보기(소품)",
        "effect": "'재미있었다'에서 멈추지 않고 글과 그림에 숨은 뜻을 찾아 읽게 됩니다. 근거를 대고 해석하는 힘이 자랍니다.",
        "tips": [
            "표지 안쪽 그림, 인물의 옷 색이 달라지는 것, 배경의 계절처럼 그림이 알려 주는 것도 훌륭한 증거로 인정해 주세요.",
            "형사들이 단서를 벽에 붙이고 실로 잇듯 증거를 붙여 이어 보면 훨씬 재미있어합니다."
        ],
        "steps": [
            {
                "title": "이상한 선택 찾기 (도입)",
                "desc": "가장 의아한 인물의 선택 하나를 골라 모두가 보이게 적습니다."
            },
            {
                "title": "숨은 증거 모으기 (전개)",
                "desc": "작가가 깔아 둔 단서와 문장 사이의 뜻을 책에서 찾아 모읍니다."
            },
            {
                "title": "까닭 세우기 (전개)",
                "desc": "모은 증거를 이어 '이런 까닭으로 그렇게 했을 것이다'라는 설명을 만듭니다."
            },
            {
                "title": "근거를 짚으며 발표하기 (정리)",
                "desc": "몇 쪽 어디인지 짚어 가며 우리 해석을 발표하고, 느낀 점을 적습니다."
            }
        ],
        "books": [
            "빨간 벽",
        ...
        "teacherScenario": {
            "intro": "늑대가 있는 산으로 가려고 스갱 아저씨의 안전한 울타리를 넘는 염소 블랑케트의 선택입니다. 우리는 탐정이 되어 그림과 문장 속 단서를 찾아, 블랑케트가 왜 위험한 자유를 골랐는지 그 까닭을 밝혀 봅시다.",
            "wrapUp": "'몇 쪽 염소의 눈빛이 울타리 밖을 향해 있다'처럼 책에서 찾은 단서를 이어 붙여 설명해 냈습니다. 어림짐작이 아니라 증거를 대는 것, 거기서 진짜 토론이 시작됩니다."
        }
    },
    {
        "id": "havruta",
        "name": "하브루타 (Havruta)",
        "concept": "짝과 마주 앉아 하나의 책을 두고 '왜?', '정말 그럴까?'를 끝없이 주고받는 토론입니다. 답을 외우는 것이 아니라 묻고 되묻는 사이에 생각이 깊어지게 하는 방식입니다. 유대인이 오래 써 온 공부 방법입니다.",
        "easy": "짝과 마주 앉아 '왜?', '정말 그럴까?'를 끊임없이 주고받으며 생각을 깊게 파고드는 유대인식 토론이에요. 질문이 많을수록 좋아요.",
        "time": "40분 (1차시)",
        "prep": "그림책, 짝끼리 마주 앉는 자리, 질문 만들기 안내문",
        "effect": "받아 적기만 하던 자리에서 벗어나 묻고 따지며 배우게 됩니다. 설명하고 지켜 내는 사이에 스스로 생각하는 힘이 자랍니다.",
        "tips": [
            "질문의 수준이 곧 하브루타의 수준입니다. '강아지똥은 무슨 색이지?' 같은 확인 질문에서 '쓸모없는 존재가 세상에 있을까?' 같은 질문으로 올라가게 도와주세요.",
            "막혔을 때 교사를 부르기보다 둘이 책을 다시 넘겨 보며 실마리를 찾게 하세요."
        ],
        "steps": [
            {
                "title": "읽고 열린 질문 만들기 (도입)",
                "desc": "그림책을 읽고 '왜', '어떻게', '만약에'로 시작하는 질문을 만듭니다."
            },
            {
                "title": "짝과 질문 주고받기 (전개)",
                "desc": "짝의 질문에 답하고, 답을 들은 사람은 다시 '왜 그렇게 생각해?'라고 되묻습니다."
            },
            {
                "title": "역할 바꿔 더 파고들기 (전개)",
                "desc": "답하다 떠오른 새 질문을 그 자리에서 만들어 대화를 이어 갑니다."
            },
            {
                "title": "가장 좋은 질문 고르기 (정리)",
                "desc": "가장 깊은 이야기를 끌어낸 질문 하나를 골라 모둠과 학급에 나눕니다."
            }
        ],
        "books": [
            "강아지똥",
        ...
        "teacherScenario": {
            "intro": "「강아지똥」을 읽었습니다. 가장 하찮게 여겨지던 것이 끝내 꽃을 피워 내는, 조용하고 굳센 사랑의 이야기입니다. 두 명씩 짝을 지어 질문을 뽑고, '왜 그렇게 생각해?', '그럼 그렇지 않은 경우는 없을까?'를 끝까지 주고받아 봅시다.",
            "wrapUp": "짝과 묻고 되묻는 사이에 처음의 투박한 생각이 한결 또렷해졌습니다. 하브루타는 상대를 이기려는 것이 아니라, 질문을 주고받으며 둘 다 몰랐던 것을 함께 찾아내는 공부입니다."
        }
    },
    {
        "id": "eraser-debate",
        "name": "지우개 토론",
        "concept": "칠판에 모둠마다 생각한 낱말이나 의견을 모두 적어 놓고, 덜 중요하다고 보는 것을 까닭을 대며 하나씩 지워 가는 토론입니다. 마지막까지 지워지지 않고 남은 것이 학급이 가장 중요하다고 본 것입니다.",
        "easy": "칠판에 적은 여러 의견 중 덜 중요한 것을 근거를 대며 하나씩 '지워' 가장 중요한 핵심만 남기는 토론이에요. 게임처럼 재미있게 우선순위를 찾아요.",
        "time": "30분 ~ 40분",
        "prep": "칠판, 보드마카나 분필, 지우개",
        "effect": "여러 의견을 견주어 무엇이 더 중요한지 가려내는 힘이 자랍니다. 지우고 남기는 과정이 놀이처럼 느껴져 부담 없이 참여합니다.",
        "tips": [
            "지울 때는 '왜 이것을 지워도 되는지' 까닭을 말해야만 지울 수 있게 약속을 정하세요.",
            "남의 의견을 깎아내리는 놀이가 아니라 '더 중요한 것'을 찾아가는 과정임을 여러 번 짚어 주세요."
        ],
        "steps": [
            {
                "title": "의견 모두 적기 (도입)",
                "desc": "그림책을 읽고 모둠마다 떠올린 가치나 해결책을 칠판에 모두 적습니다."
            },
            {
                "title": "지울 것 고르고 지킬 말 준비하기 (전개)",
                "desc": "다른 모둠 의견 가운데 지울 것을 고르고, 우리 의견을 지킬 까닭을 세웁니다."
            },
            {
                "title": "까닭을 대고 지우기 (전개)",
                "desc": "차례대로 하나씩 지목해 까닭을 말하고, 그 까닭이 받아들여지면 지웁니다."
            },
            {
                "title": "끝까지 남은 것 확인하기 (정리)",
                "desc": "마지막까지 남은 낱말을 학급의 결론으로 삼고, 왜 그것이 남았는지 함께 이야기합니다."
            }
        ],
        "books": [
            "샌지와 빵집 주인"
        ...
        "teacherScenario": {
            "intro": "빵 냄새를 맡았다고 돈을 물어내라 한 주인의 이야기입니다. 칠판에 샌지와 주인을 두고 떠올린 낱말이 가득 적혀 있습니다. 이제 한 사람씩 나와 '겹치거나, 덜 중요하거나, 근거가 약한 낱말'을 고르고 그 까닭을 말한 뒤 지워 봅시다.",
            "wrapUp": "칠판을 가득 메웠던 낱말들이 '가진 사람의 권리'와 '함께 쓰는 자유' 두 가지로 좁혀졌습니다. 토론은 말을 보태는 일이기도 하지만, 덜 중요한 것을 덜어 내고 핵심만 남기는 일이기도 합니다."
        }
    },
    {
        "id": "ai-assisted-debate",
        "name": "디지털/AI 보조 토론",
        "concept": "패들렛이나 띵커벨 같은 도구에 생각을 모으고, 챗지피티 같은 인공지능을 상대 삼아 반박을 받아 보는 토론입니다. 인공지능에게 '내 주장을 반박해 줘'라고 시킨 뒤, 그 반박을 다시 꺾어 보며 내 주장을 단단하게 만듭니다.",
        "easy": "패들렛 같은 도구나 AI를 토론 상대로 활용하는 요즘식 토론이에요. AI에게 '내 주장을 반박해 줘'라고 시켜 보고, 그 반박을 다시 꺾어 보며 논리를 단단히 해요.",
        "time": "40분 ~ 80분",
        "prep": "태블릿이나 노트북, 패들렛·띵커벨 주소, 인공지능(교사 지도 아래 사용)",
        "effect": "손을 들기 어려워하던 학생도 화면에서는 자기 생각을 내놓습니다. 미리 반박을 겪어 보기 때문에 실제 토론에서 당황하는 일이 줄어듭니다.",
        "tips": [
            "인공지능이 한 말을 그대로 믿지 않도록, 틀린 곳이나 한쪽으로 치우친 곳을 찾아보는 시간을 꼭 함께 두세요.",
            "패들렛은 이름을 감출 수 있게 하되, 함부로 쓰지 않기로 미리 약속하고 시작하세요."
        ],
        "steps": [
            {
                "title": "화면에 생각 붙이기 (도입)",
                "desc": "패들렛에 논제를 올리고, 모두가 한꺼번에 자기 생각을 붙입니다."
            },
            {
                "title": "인공지능에게 반박받기 (전개)",
                "desc": "내 주장을 입력하고 '반박해 줘'라고 요청해, 나올 만한 반론을 미리 받아 봅니다."
            },
            {
                "title": "반박을 꺾을 말 만들기 (전개)",
                "desc": "받은 반론을 꺾을 근거를 모둠이 함께 정리합니다."
            },
            {
                "title": "발표하고 함께 정하기 (정리)",
                "desc": "다듬은 주장을 발표하고, 투표 기능으로 학급의 결론을 모읍니다."
            }
        ],
        "books": [
            "30번 곰"
        ...
        "teacherScenario": {
            "intro": "생태계 파괴에 맞서 동물을 복제하는 일이 옳은지 이야기해 봅시다. 각자 태블릿을 켜고 인공지능에게 '내 주장을 무너뜨릴 반론 세 가지를 들어 줘'라고 물어보세요. 그 반론이 맞는 말인지 따져 보고, 꺾을 수 있는 근거를 모둠이 함께 적어 봅시다.",
            "wrapUp": "인공지능이 한 말을 그대로 믿지 않고 오히려 연습 상대로 삼아, 내 주장의 허점을 스스로 찾아 메웠습니다. 기술에 끌려가지 않고 도구로 부리는 모습이 아주 좋았습니다."
        }
    },
    {
        "id": "doublepyramid",
        "name": "쌍 피라미드 토론",
        "concept": "찬성 쪽과 반대 쪽이 따로 의견을 좁혀 가는 토론입니다. 혼자에서 둘로, 둘에서 넷으로 짝을 넓히며 더 나은 안을 고르고, 각 편에서 대표 의견을 하나씩 뽑습니다. 마지막에 두 대표 의견을 마주 놓고 더 나은 해결책을 찾습니다.",
        "easy": "찬성 팀과 반대 팀이 각각 1:1 → 2:2로 의견을 모아 대표 의견을 하나씩 만든 뒤, 둘을 합쳐 더 나은 해결책을 찾는 토론이에요.",
        "time": "80분 (2차시)",
        "prep": "단계별 의견 정리표, 모둠 의견을 모을 판",
        "effect": "목소리 큰 사람이나 다수결에 밀리지 않고, 단계를 거치며 좋은 의견이 살아남습니다. 여럿의 생각을 하나로 모으는 방법을 익힙니다.",
        "tips": [
            "짝을 넓힐 때마다 앞 상대의 좋은 근거를 가져와 우리 안을 고쳐 가도록 이끌어 주세요.",
            "마지막에는 찬성 대표 안과 반대 대표 안을 합쳐 새 해결책을 만들게 하면 좋습니다."
        ],
        "steps": [
            {
                "title": "혼자 쓰고 짝과 고르기 (도입)",
                "desc": "내 입장에 맞는 안을 하나 적고, 짝과 견주어 더 나은 안을 고릅니다."
            },
            {
                "title": "넷이 모여 다듬기 (전개)",
                "desc": "네 명이 모여 두 안 가운데 모둠 대표 안을 정하고 더 낫게 고칩니다."
            },
            {
                "title": "편마다 대표 안 하나 정하기 (전개)",
                "desc": "찬성 모둠끼리, 반대 모둠끼리 모여 각 편을 대표할 안을 하나씩 정합니다."
            },
            {
                "title": "두 대표 안을 마주 놓기 (정리)",
                "desc": "찬성 대표 안과 반대 대표 안을 견주며 둘을 아우르는 새 안을 만듭니다."
            }
        ],
        "books": [
            "누가 내 머리에 똥 쌌어?"
        ...
        "teacherScenario": {
            "intro": "머리에 똥을 맞은 두더지가 똑같이 갚아 주는 결말을 보았지요. 이 되갚음이 옳은지를 두고 찬성 팀과 반대 팀으로 나뉘어, 혼자에서 둘로, 둘에서 넷으로 의견을 좁혀 가며 각 편의 가장 좋은 주장을 뽑아 봅시다.",
            "wrapUp": "양쪽에서 뽑은 가장 좋은 주장을 마주 놓고 이야기하니, 감정으로 맞서는 대신 진실을 밝히는 일과 상대를 배려하는 일을 함께 지키는 길이 나왔습니다. 이것이 이 토론의 힘입니다."
        }
    },
    {
        "id": "angeldevil",
        "name": "두 마음(천사-악마) 토론",
        "concept": "고민하는 인물 한 명을 가운데 앉히고, 양옆에서 천사와 악마가 되어 설득하는 역할극 토론입니다. 천사는 옳은 쪽을, 악마는 솔직한 욕심 쪽을 대신 말해 줍니다. 마음속에서만 오가던 갈등이 눈앞에서 소리로 들립니다.",
        "easy": "고민하는 주인공 양옆에서 한 편은 천사(착한 마음), 한 편은 악마(솔직한 욕심)가 되어 설득하는 역할극 토론이에요. 마음속 갈등을 눈으로 보여 줍니다.",
        "time": "40분 (1차시)",
        "prep": "천사·악마 머리띠, 고민 상황 정리지",
        "effect": "한 사람의 마음속에 서로 다른 생각이 함께 있다는 것을 알게 됩니다. 나중에 자기가 고민할 때도 양쪽을 나란히 놓고 따져 보게 됩니다.",
        "tips": [
            "천사와 악마가 서로를 몰아세우지 않게 하세요. 인물의 솔직한 마음과 옳은 마음을 각각 재미있게 대변하도록 안내합니다.",
            "가운데 앉아 듣는 역할을 모두가 한 번씩 맡도록 작은 모둠으로 나눠 진행하면 좋습니다."
        ],
        "steps": [
            {
                "title": "고민하는 인물 정하기 (도입)",
                "desc": "그림책 속 갈등 장면을 함께 확인하고, 가운데 앉을 인물을 정합니다."
            },
            {
                "title": "양쪽 할 말 준비하기 (전개)",
                "desc": "천사 편은 옳은 쪽 까닭을, 악마 편은 솔직한 욕심 쪽 까닭을 준비합니다."
            },
            {
                "title": "귓가에서 번갈아 설득하기 (전개)",
                "desc": "가운데 앉은 인물의 양옆에서 번갈아 가며 조용히 설득합니다."
            },
            {
                "title": "고르고 돌아보기 (정리)",
                "desc": "양쪽 말을 다 들은 인물이 선택을 하고, 왜 그렇게 정했는지 적습니다."
            }
        ],
        "books": [
            "문 밖에 사자가 있다"
        ...
        "teacherScenario": {
            "intro": "유리병에 행복을 담아 파는 가게에 사람들이 줄을 섰지요. 오늘은 행복을 사려는 주인공 양옆에서 착한 마음을 말하는 천사와 솔직한 욕심을 말하는 악마가 되어 설득해 보겠습니다. 가운데 앉은 친구는 양쪽 말을 다 듣고 스스로 정하면 됩니다.",
            "wrapUp": "천사와 악마의 말을 다 들어 보니, 우리 마음속 갈등도 이렇게 서로 다른 바람이 부딪쳐 생기는 것이었지요. 남의 눈을 좇기보다 내 마음을 있는 그대로 받아들일 때 그 갈등이 풀린다는 것을 배웠습니다."
        }
    },
    {
        "id": "hexadebate",
        "name": "헥사 토론",
        "concept": "육각형 카드에 책 속 낱말, 인물, 사건, 감정을 하나씩 적고, 서로 이어진다고 생각하는 카드끼리 변을 맞대어 붙이는 토론입니다. 붙일 때마다 '이 둘이 왜 이어지는지'를 말해야 합니다. 다 붙이고 나면 사건과 감정의 얽힘이 벌집 모양으로 한눈에 보입니다.",
        "easy": "육각형 카드에 단어를 적고, 서로 관련 있는 카드끼리 이어 붙이며 '왜 연결되는지'를 설명하는 토론이에요. 사건과 감정의 관계가 벌집처럼 한눈에 보여요.",
        "time": "80분 (2차시)",
        "prep": "육각형 카드, 마커펜, 붙일 판",
        "effect": "따로 떨어져 있던 사건과 감정이 어떻게 이어지는지 눈으로 보게 됩니다. 원인과 결과를 따져 말하는 힘이 자랍니다.",
        "tips": [
            "카드가 맞닿는 변에 '왜 이어지는지'를 적은 쪽지를 붙이게 하면 설명이 더 또렷해집니다.",
            "가장 많은 카드와 이어진 카드를 찾아 '가운데 카드'로 삼으면 무엇이 핵심 쟁점인지 드러납니다."
        ],
        "steps": [
            {
                "title": "카드에 낱말 적기 (도입)",
                "desc": "그림책에서 떠오른 낱말, 인물, 사건, 가치를 육각형 카드에 하나씩 적습니다."
            },
            {
                "title": "이어 붙이며 까닭 말하기 (전개)",
                "desc": "차례대로 카드를 맞붙이며 두 낱말이 왜 이어지는지 설명합니다."
            },
            {
                "title": "벌집 모양에서 핵심 찾기 (전개)",
                "desc": "완성된 벌집 모양을 보며 갈등의 한가운데에 있는 쟁점을 찾아 이야기합니다."
            },
            {
                "title": "이어진 그림으로 정리하기 (정리)",
                "desc": "카드가 이어진 모양을 근거로 그림책의 갈등을 글로 정리해 나눕니다."
            }
        ],
        "books": [
            "벌집이 너무 좁아"
        ...
        "teacherScenario": {
            "intro": "벌집이 좁아져 꿀벌들이 다투는 이야기입니다. 육각형 카드에 낱말을 하나씩 적고 서로 이어지는 카드끼리 변을 맞대어 붙이면서, 다툼의 원인과 그것을 풀어 갈 길을 하나의 그림으로 그려 봅시다.",
            "wrapUp": "카드가 이어져 커다란 벌집 모양이 된 것을 보니, 다툼의 원인이 한 가지 사건이 아니라 쌓인 오해와 끊긴 말들이었다는 것이 눈에 보입니다. 복잡한 일을 이렇게 그림으로 펼쳐 보는 눈을 길러 갑시다."
        }
    }
];
...
const books = [
    {
        ...
        "summary": "아이를 상품처럼 사고파는 대형 마트가 있습니다. 뒤프레 부부는 얌전하고 똑똑한 '1등급' 아이 바티스트를 골라 집으로 데려옵니다. 바티스트는 부모의 까다로운 기준을 하나하나 맞추며 지내지만, 받아쓰기에서 한 글자를 틀리고 맙니다. 실망한 부모가 아이를 마트에 물리러 가자, 바티스트는 그 자리에서 마트 점원에게 되묻습니다. 완벽한 부모님도 파느냐고. 사람을 성능으로 따져 고르고 마음에 들지 않으면 되돌려 보내는 세상을, 아이의 한마디로 뒤집어 보여 줍니다.",
        "technique": "파노라마 토론",
        "tags": [
            "#아동인권",
            "#완벽주의비판",
        ...
        "isBestseller": true,
        "debateTopics": [
            "부모는 왜 아이를 마트에서 골라 왔을까? 그들이 바란 '완벽함'은 누구를 위한 것이었을까?",
            "바티스트가 진열장에 서 있을 때, 그리고 부모가 자기를 물리러 왔을 때 마음은 어땠을까?",
            "아이를 성능으로 나누어 진열해 두는 마트는 우리 사회의 무엇을 닮았을까?"
        ],
        "debatePropositions": [
            "부모를 실망시키지 않으려고 자신의 부족한 점을 숨기는 것은 잘못이 아니다.",
            "아이의 성적과 하루 일과를 부모가 정해 주는 것은 아이를 위한 일이다."
        ],
        "coverId": 0
    },
    {
...
const literatureWorks = [
    ...
    { genre: "현대소설", title: "오발탄", author: "이범선", year: "1959", level: "고등",
      summary: "계리사 사무실 서기인 송철호는 해방촌 판잣집에서 식구들을 건사합니다. 어머니는 정신을 놓은 채 \"가자, 가자\"만 외치고, 만삭의 아내는 말이 없으며, 동생 영호는 번듯한 일자리를 구하지 못하고, 여동생 명숙은 미군 상대로 돈을 벌어 옵니다. 철호는 앓는 어금니를 뽑을 돈도 아까워 참고 지냅니다. 양심대로 살아 봐야 남는 것이 없다며 은행을 털던 영호가 붙잡히고, 같은 날 아내는 병원에서 숨을 거둡니다. 철호는 참아 오던 어금니를 한꺼번에 뽑고 택시에 올라 갈 곳을 대지 못한 채 피를 흘립니다. 운전사는 그를 두고 잘못 쏜 탄환 같은 손님이라고 말합니다.",
      conflict: "양심을 지키려는 철호와 그 양심이 무슨 소용이냐고 묻는 영호",
      question: "성실하게 살았는데도 삶이 무너진다면, 그 책임은 누구에게 있는가?",
      derived: [
        { type: "value", claim: "어떤 형편에서도 양심을 지키며 사는 것이 옳다." },
        { type: "fact", claim: "성실하게 일해도 가난에서 벗어나지 못하는 사람이 있다." }
      ],
      topics: ["노력하면 누구나 성공할 수 있다.", "모두가 속일 때 혼자 정직하면 손해를 본다."],
      books: ["빈 화분", "내가 라면을 먹을 때"] },
...
function setupWorksheetGenerator() {
    ...
    const wsTechLens = (book, type) => {
        ...
        const map = {
            ...
            panorama:     { focus: `《${t}》의 사건을 세 자리에서 나란히 보며, 서로를 꺾기보다 이해하는 쪽으로 이야기를 이끕니다.`, point: q },
    ...
    if (type === "basic") {
        worksheetHTML += `
            ...
            <div class="ws-section">
                ...
                <textarea class="ws-textarea-box" placeholder="내 주장, 그렇게 보는 까닭, 덧붙일 설명의 차례로 적어 보세요..."></textarea>
            </div>
        `;
        ...
        worksheetHTML += `
            <div class="ws-section">
                ...
                <table class="ws-table">
                    ...
                    <tr>
                        <td>
                            <textarea style="height: 90px;" placeholder="내가 처음 떠올린 조언을 적어 주세요..."></textarea>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td>
                            <textarea style="height: 90px;" placeholder="앞사람이 쓴 것을 읽고, 어떻게 해 볼지를 더 자세히 보태 주세요..."></textarea>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td>
                            <textarea style="height: 90px;" placeholder="앞의 두 결론을 합치고, 뜻밖의 경우에 대비할 방법을 덧붙여 주세요..."></textarea>
                        </td>
                    </tr>
                </table>
            </div>
            <div class="ws-section">
                ...
                <textarea class="ws-textarea-box" placeholder="모두의 손을 거쳐 돌아온 생각 가운데 가장 좋은 해결책을 골라 다듬어 적으세요..."></textarea>
            </div>
        `;
    } else if (type === "procon") {
        worksheetHTML += `
            <div class="ws-section">
                ...
                <table class="ws-table">
                    ...
                    <tr>
                        <td>
                            <textarea style="min-height: 220px;" placeholder="내 생각과 달라도 좋습니다. 찬성하는 자리에 서서 가장 그럴듯한 주장과 근거를 두 가지 이상 적으세요..."></textarea>
                        </td>
                        <td>
                            <textarea style="min-height: 220px;" placeholder="편을 바꾼 뒤, 조금 전 내 주장의 빈틈을 스스로 짚어 가며 반대쪽에서 댈 수 있는 가장 좋은 근거를 적으세요..."></textarea>
                        </td>
                    </tr>
                </table>
            </div>
            <div class="ws-section">
                <h4>⚖️ 3단계. 양쪽을 다 맡아 본 뒤 정리하는 내 생각</h4>
                <textarea class="ws-textarea-box" placeholder="양쪽을 모두 말해 보며 알게 된 것을 적어 보세요. 어느 한쪽으로만 나눌 수 없었던 까닭도 함께 적습니다..."></textarea>
            </div>
        `;
    } else if (type === "hotseating") {
        worksheetHTML += `
            <div class="ws-section">
                <h4>🪑 핫시팅 · 인물에게 물어본 것 정리</h4>
                <p style="font-size: 0.85rem; color: #555555; margin-bottom: 12px;">뜨거운 의자에 앉은 주인공에게 속마음을 물어봅니다.</p>
                ...
                <table class="ws-table">
                    ...
                    <tr>
                        ...
                        <td>
                            <textarea style="min-height: 200px;" placeholder="주인공이 변명 대신 털어놓은 속사정과 슬픔을 받아 적어 정리하세요..."></textarea>
                        </td>
                    </tr>
                </table>
            </div>
            <div class="ws-section">
                <h4>✉️ 《${book.title}》 주인공에게 보내는 위로와 응원의 편지</h4>
                <textarea class="ws-textarea-box" placeholder="주인공의 외로움을 헤아린 뒤, 더 나은 선택을 하도록 돕는 따뜻한 말을 적어 주세요..."></textarea>
            </div>
        `;
    } else if (type === "carousel") {
        worksheetHTML += `
            <div class="ws-section">
                <h4>🎠 회전목마 토론 · 짝마다 들은 생각 기록지</h4>
                <p style="font-size: 0.85rem; color: #555555; margin-bottom: 12px;">(자리를 바꿔 가며 만난 친구들의 생각을 모읍니다.)</p>
                <div style="background-color: #fcf8f2; padding: 12px; border-radius: 8px; margin-bottom: 16px; border-left: 4px solid var(--accent-coral);">
                    <p style="font-weight: 700; font-size: 0.9rem; margin-bottom: 4px; color: var(--accent-coral);">📚 권장 토론 논제:</p>
                    <ul style="padding-left: 20px; font-size: 0.85rem; line-height: 1.6; color: #333333; margin: 0;">
                        ${book.debatePropositions ? book.debatePropositions.map(t => `<li>${t}</li>`).join("") : '<li>추천 논제 정보가 없습니다.</li>'}
            ...
            <div class="ws-section">
                <h4>🌟 여러 의견을 듣고 한 걸음 나아간 내 생각</h4>
                <textarea class="ws-textarea-box" placeholder="여러 친구와 짝 토론을 하는 동안 내 주장의 빈 곳이 어떻게 채워졌는지 정리해 보세요..."></textarea>
            </div>
        `;
    } else if (type === "socratic") {
        worksheetHTML += `
            <div class="ws-section">
                <h4>📖 소크라틱 세미나 대화 기록</h4>
                <p style="font-size: 0.85rem; color: #555555; margin-bottom: 12px;">정답을 겨루는 대신, 책이 우리에게 말하려는 것에 대해 이야기합니다.</p>
                ...
                <textarea style="width: 100%; min-height: 80px; padding: 10px; border:1px solid #ccc; border-radius:6px; margin-bottom: 16px;" placeholder="오늘의 큰 질문과, 내 생각을 받쳐 주는 책 속 문장을 쪽수와 함께 옮겨 적으세요..."></textarea>
                ...
                <table class="ws-table">
                    ...
                    <tr>
                        <td>
                            <textarea style="min-height: 160px;" placeholder="친구의 말 가운데 나를 한 번 멈춰 세운 생각은 무엇이었나요?..."></textarea>
                        </td>
                        <td>
                            <textarea style="min-height: 160px;" placeholder="토론 전에는 보이지 않았는데 오늘 새로 알게 된 책의 뜻을 쓰세요..."></textarea>
                        </td>
                    </tr>
                </table>
            </div>
            <div class="ws-section">
                <h4>📝 오늘 대화를 정리하는 글</h4>
                <textarea class="ws-textarea-box" placeholder="오늘 나눈 이야기를 바탕으로 '함께 사는 일' 또는 '내 뜻대로 사는 일'에 대한 내 생각을 한 편의 글로 써 주세요..."></textarea>
            </div>
        `;
        ...
        worksheetHTML += `
            <div class="ws-section">
                <h4>☕ 월드카페 생각 모음판</h4>
                <p style="font-size: 0.85rem; color: #555555; margin-bottom: 12px;">카페처럼 편한 자리에서 낙서하듯 자유롭게 적으며 생각을 섞습니다.</p>
                <div style="background-color: #f2f6fc; padding: 12px; border-radius: 8px; margin-bottom: 16px; border-left: 4px solid var(--accent-sage);">
                    <p style="font-weight: 700; font-size: 0.9rem; margin-bottom: 4px; color: var(--accent-sage);">📚 권장 토론 논제:</p>
                    <ul style="padding-left: 20px; font-size: 0.85rem; line-height: 1.6; color: #333333; margin: 0;">
                        ${book.debatePropositions ? book.debatePropositions.map(t => `<li>${t}</li>`).join("") : '<li>추천 논제 정보가 없습니다.</li>'}
                ...
                <table class="ws-table">
                    ...
                    <tr>
                        <td>
                            <textarea style="min-height: 180px;" placeholder="처음에 모둠원들과 큰 종이에 자유롭게 적어 모았던 생각들..."></textarea>
                        </td>
                        <td>
                            <textarea style="min-height: 180px;" placeholder="자리 주인의 설명과, 앞서 다녀간 친구들이 종이에 남긴 생각 정리..."></textarea>
                        </td>
                    </tr>
                </table>
            </div>
            <div class="ws-section">
                <h4>☕ 원래 자리로 돌아와 모둠이 정리한 마지막 해결책</h4>
                <textarea class="ws-textarea-box" placeholder="다른 테이블을 다녀온 친구들이 모아 온 생각을 자리 주인과 함께 정리해, 마지막 결론을 적으세요..."></textarea>
            </div>
        `;
    } else if (type === "argument") {
        worksheetHTML += `
            <div class="ws-section">
                <h4>🎲 논증 게임 · 주장·이유·근거 맞추기 활동지</h4>
                <p style="font-size: 0.85rem; color: #555555; margin-bottom: 12px;">친구들이 인정해 준 가장 좋은 세 마디를 글로 적어 둡니다.</p>
                <div style="background-color: #f2f6fc; padding: 12px; border-radius: 8px; margin-bottom: 16px; border-left: 4px solid var(--accent-sage);">
                    <p style="font-weight: 700; font-size: 0.9rem; margin-bottom: 4px; color: var(--accent-sage);">📚 권장 토론 논제:</p>
                    <ul style="padding-left: 20px; font-size: 0.85rem; line-height: 1.6; color: #333333; margin: 0;">
                        ${book.debatePropositions ? book.debatePropositions.map(t => `<li>${t}</li>`).join("") : '<li>추천 논제 정보가 없습니다.</li>'}
                ...
                <table class="ws-table">
                    ...
                    <tr>
                        <td>
                            <textarea style="min-height: 150px;" placeholder="~라고 생각합니다. (인물의 갈등에 대한 내 입장을 한 문장으로)"></textarea>
                        </td>
                        <td>
                            <textarea style="min-height: 150px;" placeholder="왜냐하면 ~이기 때문입니다. (그렇게 보는 까닭)"></textarea>
                        </td>
                        <td>
                            <textarea style="min-height: 150px;" placeholder="예를 들어 그림책 ○○쪽의 문장이나 그림을 보면 ~라고 나옵니다. (책에서 찾은 증거)"></textarea>
                        </td>
                    </tr>
                    <tr>
                        <td>
        ...
        worksheetHTML += `
            <div class="ws-section">
                <h4>⚖️ 찬반 토론을 지켜본 판정단 의견서</h4>
                <p style="font-size: 0.85rem; color: #555555; margin-bottom: 12px;">대표들의 토론을 공정하게 듣고 판단해 마지막 결정을 적습니다.</p>
                <div style="background-color: #f2f6fc; padding: 12px; border-radius: 8px; margin-bottom: 16px; border-left: 4px solid var(--accent-sage);">
                    <p style="font-weight: 700; font-size: 0.9rem; margin-bottom: 4px; color: var(--accent-sage);">📚 권장 토론 논제:</p>
                    <ul style="padding-left: 20px; font-size: 0.85rem; line-height: 1.6; color: #333333; margin: 0;">
                        ${book.debatePropositions ? book.debatePropositions.map(t => `<li>${t}</li>`).join("") : '<li>추천 논제 정보가 없습니다.</li>'}
                ...
                <table class="ws-table">
                    ...
                    <tr>
                        <td>
                            <textarea style="min-height: 160px;" placeholder="찬성 측 근거 가운데 가장 그럴듯했던 점과 허술했던 점을 적으세요..."></textarea>
                        </td>
                        <td>
                            <textarea style="min-height: 160px;" placeholder="반대 측 근거 가운데 가장 그럴듯했던 점과 허술했던 점을 적으세요..."></textarea>
                        </td>
                    </tr>
                </table>
            </div>
            <div class="ws-section">
                <h4>🗳️ 지켜보며 내가 직접 던진 질문</h4>
                <textarea style="width:100%; min-height:60px; padding:10px; border:1px solid #ccc; border-radius:6px; margin-bottom:16px;" placeholder="토의 중 설명이 모자라 궁금했던 질문과 그에 대한 답 정리..."></textarea>
                
                <h4>🏛️ 판정단의 마지막 결정 (표결 결과와 함께 살 길)</h4>
                <textarea class="ws-textarea-box" placeholder="투표 결과와 소수 의견을 함께 담아, 우리 학급이 정한 약속을 소리 내어 읽을 수 있게 적어 주세요..."></textarea>
            </div>
        `;
    } else if (type === "openspace") {
        worksheetHTML += `
            <div class="ws-section">
                <h4>🌍 스스로 고른 주제로 나눈 토의 기록</h4>
                <p style="font-size: 0.85rem; color: #555555; margin-bottom: 12px;">참여한 사람들이 직접 낸 주제 가운데 고른 방에서 나눈 이야기를 적는 기록장입니다.</p>
                <div class="ws-recommend-topics-box no-print" style="margin-bottom:12px; padding:10px; background-color:#fef8f5; border-radius:8px; border:1px solid rgba(224,122,95,0.15); font-size:0.85rem;">
                ...
                <div style="margin-top: 16px;">
                    <h4>💬 옮겨 다니며 들은 이야기 정리</h4>
                    <p style="font-size: 0.85rem; color: #555555; margin-bottom: 8px;">배울 것도 보탤 것도 없으면 다른 방으로 옮겨도 좋습니다. 돌아다니며 들은 이야기를 정리해 보세요.</p>
                    <textarea class="ws-textarea-box" style="min-height: 180px;" placeholder="우리가 만난 생각 1:\n우리가 만난 생각 2:\n대안 해결 아이디어들:..."></textarea>
                </div>
            </div>
            <div class="ws-section">
                <h4>🌱 토론을 마치고 함께 지킬 약속</h4>
                <textarea class="ws-textarea-box" placeholder="말로만 그치지 않도록, 교실과 집에서 오늘부터 지킬 약속 세 가지를 적으세요..."></textarea>
            </div>
        `;
    } else if (type === "leadership") {
        worksheetHTML += `
            <div class="ws-section">
                <h4>👑 주도권 토론 · 되묻기 질문 준비지</h4>
                <p style="font-size: 0.85rem; color: #555555; margin-bottom: 12px;">내 차례에 상대의 주장을 꼼꼼히 되물어 이야기를 이끌어 가기 위한 준비지입니다.</p>
                <div style="background-color: #fcf8f2; padding: 12px; border-radius: 8px; margin-bottom: 16px; border-left: 4px solid var(--accent-coral);">
                    <p style="font-weight: 700; font-size: 0.9rem; margin-bottom: 4px; color: var(--accent-coral);">📚 권장 토론 논제:</p>
                    <ul style="padding-left: 20px; font-size: 0.85rem; line-height: 1.6; color: #333333; margin: 0;">
                        ${book.debatePropositions ? book.debatePropositions.map(t => `<li>${t}</li>`).join("") : '<li>추천 논제 정보가 없습니다.</li>'}
                ...
                <table class="ws-table">
                    ...
                    <tr>
                        <td>
                            <textarea style="min-height: 180px;" placeholder="상대 주장에서 앞뒤가 맞지 않는 곳을 짚어, 짧게 답할 수 있게 묻는 질문 목록...\n- 질문 1:\n- 질문 2:..."></textarea>
                        </td>
                        <td>
                            <textarea style="min-height: 180px;" placeholder="상대가 몰아붙일 때에도 이야기가 흐트러지지 않도록, 짧고 단단하게 답할 문장들..."></textarea>
                        </td>
                    </tr>
                </table>
            </div>
            <div class="ws-section">
                <h4>⚙️ 3단계. 오늘 내 질문을 돌아보기</h4>
                <textarea class="ws-textarea-box" placeholder="오늘 어떤 질문이 상대의 빈 곳을 잘 짚었는지, 답이 길어질 때 잘 끊어 주었는지 스스로 돌아보고 적으세요..."></textarea>
            </div>
        `;
        ...
        worksheetHTML += `
            ...
            <div class="ws-section">
                ...
                <p style="font-size: 0.85rem; color: #555555; margin-bottom: 8px;">토론 전과 견주어 내 카드 색은 어떻게 바뀌었나요? 바뀐 까닭이나 더 굳어진 결론을 적으세요.</p>
        ...
        worksheetHTML += `
            <div class="ws-section">
                <h4>💡 오늘의 논제: 《${book.title}》 속 주인공의 선택 따져 보기</h4>
            ...
            <div class="ws-section">
                <h4>🔍 세 칸을 살펴본 뒤 내린 내 결론</h4>
                <p style="font-size: 0.85rem; color: #555555; margin-bottom: 8px;">좋은 점·아쉬운 점·흥미로운 점을 살핀 결과를 바탕으로, 나라면 어떻게 할지 적으세요.</p>
                <textarea class="ws-textarea-box" placeholder="양쪽을 고루 살펴본 끝에 내가 내놓는 새 주장을 적어 보세요..."></textarea>
            </div>
        `;
    } else if (type === "twostray") {
        worksheetHTML += `
            <div class="ws-section">
                <h4>🧭 둘 가고 둘 남기 · 생각 나누기 활동지</h4>
                <p style="font-size: 0.85rem; color: #555555; margin-bottom: 12px;">모둠에서 이야기한 뒤 다른 모둠을 찾아다니며 배워 옵니다.</p>
                <div style="background-color: #f2f6fc; padding: 12px; border-radius: 8px; margin-bottom: 16px; border-left: 4px solid var(--accent-sage);">
                    <p style="font-weight: 700; font-size: 0.9rem; margin-bottom: 4px; color: var(--accent-sage);">📚 권장 토론 논제:</p>
                    <ul style="padding-left: 20px; font-size: 0.85rem; line-height: 1.6; color: #333333; margin: 0;">
                        ${book.debatePropositions ? book.debatePropositions.map(t => `<li>${t}</li>`).join("") : '<li>추천 논제 정보가 없습니다.</li>'}
                ...
                <table class="ws-table">
                    ...
                    <tr>
                        <td>
                            <textarea style="min-height: 180px;" placeholder="우리 모둠이 《${book.title}》에 대해 정리한 주장..."></textarea>
                        </td>
                        <td>
                            <textarea style="min-height: 180px;" placeholder="다른 모둠을 돌며 얻은, 우리 주장의 빈 곳을 채워 줄 생각들..."></textarea>
                        </td>
                    </tr>
                </table>
            </div>
            <div class="ws-section">
                <h4>🌟 다녀와 모은 생각을 더해 완성한 우리 모둠 정리</h4>
                <textarea class="ws-textarea-box" placeholder="남아 있던 친구와 다녀온 친구가 함께 완성한 우리 모둠의 마지막 정리..."></textarea>
            </div>
        `;
        ...
        worksheetHTML += `
            <div class="ws-section">
                ...
                <p style="font-size: 0.85rem; color: #555555; margin-bottom: 12px;">선풍기 날개가 돌듯, 앞사람 말을 요약한 뒤에만 내 생각을 얹을 수 있습니다.</p>
                <div style="background-color: #f2f6fc; padding: 12px; border-radius: 8px; margin-bottom: 16px; border-left: 4px solid var(--accent-sage);">
                    <p style="font-weight: 700; font-size: 0.9rem; margin-bottom: 4px; color: var(--accent-sage);">📚 권장 토론 논제:</p>
                    <ul style="padding-left: 20px; font-size: 0.85rem; line-height: 1.6; color: #333333; margin: 0;">
                        ${book.debatePropositions ? book.debatePropositions.map(t => `<li>${t}</li>`).join("") : '<li>추천 논제 정보가 없습니다.</li>'}
                ...
                <table class="ws-table">
                    ...
                    <tr>
                        <td>
                            <textarea style="height: 80px;" placeholder="《${book.title}》의 갈등에 대해 내가 처음 떠올린 생각을 짧게 쓰세요..."></textarea>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td>
                            <textarea style="height: 90px;" placeholder="'앞사람 ○○는 ~라고 말했다. 나는 여기에 ~을 보태고 싶다' 틀에 맞춰 적어 보세요..."></textarea>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td>
                            <textarea style="height: 100px;" placeholder="모둠원 모두의 귀를 거치며 눈덩이처럼 불어난 마지막 생각을 쓰세요..."></textarea>
                        </td>
                    </tr>
                </table>
            </div>
        ...
        worksheetHTML += `
            <div class="ws-section">
                ...
                <table class="ws-table">
                    ...
                    <tr>
                        <td>
                            <textarea placeholder="그림책에서 가장 이해하기 어려웠던 인물의 행동을 하나 골라 적어 보세요..."></textarea>
                        </td>
                        <td>
                            <textarea placeholder="인물이 안팎으로 겪은 갈등과, 왜 그렇게 정할 수밖에 없었는지 숨은 마음을 헤아려 적어 보세요..."></textarea>
                        </td>
                    </tr>
                </table>
            </div>
            ...
            <div class="ws-section">
                <h4>🔎 내 생각을 받쳐 주는 책 속 단서 찾기</h4>
                <p style="font-size: 0.85rem; color: #555555; margin-bottom: 8px;">내 생각을 받쳐 주는 책 속 문장이나 그림의 단서(색, 표정, 배경 물건 등)를 찾아 적으세요.</p>
                <textarea class="ws-textarea-box" placeholder="예: '○○쪽 주인공의 표정이 어두운 것으로 보아 ~라고 생각한다'처럼 증거를 들어 적으세요..."></textarea>
            </div>
        `;
        ...
        worksheetHTML += `
            ...
            <table class="ws-table" style="margin-top: 40px;">
                ...
                <tr>
                    <td>
                        <textarea placeholder="내가 그 자리에 선 까닭을, 옳고 그름과 현실 형편 두 가지로 나눠 적어 보세요..."></textarea>
                    </td>
                    <td>
                        <textarea placeholder="친구들의 말을 듣고 자리를 옮겼나요? 옮겼는지 아닌지와 마지막 결론을 적어 보세요..."></textarea>
                    </td>
                </tr>
            </table>
        `;
        ...
        worksheetHTML += `
            <div class="ws-section">
                <h4>👼 두 마음(천사·악마) 토론 대화 기록</h4>
                <p style="font-size: 0.85rem; color: #555555; margin-bottom: 12px;">주인공의 고민을 두고 마음속 천사와 악마가 되어 건넬 말을 준비해 봅시다.</p>
                <div style="background-color: #f2f6fc; padding: 12px; border-radius: 8px; margin-bottom: 16px; border-left: 4px solid var(--accent-sage);">
                ...
                <table class="ws-table">
                    ...
                    <tr>
                        <td>
                            <textarea style="min-height: 220px;" placeholder="옳고 그름, 남에 대한 배려, 지켜야 할 권리를 들어 주인공이 바른 선택을 하도록 설득해 보세요..."></textarea>
                        </td>
                        <td>
                            <textarea style="min-height: 220px;" placeholder="손익을 따지는 현실적인 눈으로, 주인공이 가장 손해 보지 않는 길을 가도록 부추겨 보세요..."></textarea>
                        </td>
                    </tr>
                </table>
            </div>
            <div class="ws-section">
                <h4>🛡️ 결정의 무게 · 내 마지막 생각</h4>
                <p style="font-size: 0.85rem; color: #555555; margin-bottom: 8px;">양쪽 말을 다 들은 뒤, 내가 내린 결론과 그 까닭을 적으세요.</p>
                <textarea class="ws-textarea-box" style="min-height: 120px;" placeholder="한쪽을 골랐나요, 둘을 아울렀나요? 내가 내린 결론과 그 까닭을 자세히 적으세요..."></textarea>
            </div>
        `;
    } else if (type === "doublepyramid") {
        worksheetHTML += `
            <div class="ws-section">
                <h4>📐 쌍 피라미드 토론 · 의견 좁혀 가기 활동지</h4>
                <p style="font-size: 0.85rem; color: #555555; margin-bottom: 12px;">혼자에서 짝으로, 짝에서 모둠으로 생각을 좁혀 가며 하나의 안을 만들어 봅시다.</p>
                <div style="background-color: #fcf8f2; padding: 12px; border-radius: 8px; margin-bottom: 16px; border-left: 4px solid var(--accent-coral);">
                ...
                <table class="ws-table">
                    ...
                    <tr>
                        <td>
                            <textarea style="height: 80px;" placeholder="이 논제에 대한 내 주장과 그 까닭을 자유롭게 적으세요..."></textarea>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td>
                            <textarea style="height: 80px;" placeholder="짝과 생각을 맞춰 더 단단해진 하나의 주장을 적으세요..."></textarea>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td>
                            <textarea style="height: 80px;" placeholder="모둠 전체(4~6명)가 짝마다 가져온 안을 놓고 이야기해 정한 대표 주장을 적으세요..."></textarea>
                        </td>
                    </tr>
                </table>
            </div>
            <div class="ws-section">
                <h4>🌟 찬성과 반대를 아우르는 새 해결책</h4>
                <p style="font-size: 0.85rem; color: #555555; margin-bottom: 8px;">찬성 쪽과 반대 쪽의 대표 주장을 합쳐, 모두가 함께 살아갈 새 해결책을 만들어 보세요.</p>
                <textarea class="ws-textarea-box" style="min-height: 100px;" placeholder="찬성과 반대로 갈라서지 않고, 《${book.title}》의 문제를 함께 풀 수 있는 길을 적으세요..."></textarea>
            </div>
        `;
    } else if (type === "hexadebate") {
        worksheetHTML += `
            <div class="ws-section">
                <h4>⬡ 헥사 토론 · 낱말을 이어 보는 활동지</h4>
                <p style="font-size: 0.85rem; color: #555555; margin-bottom: 12px;">그림책 속 낱말을 육각형 카드로 이어 붙이며 사건들이 어떻게 얽혀 있는지 눈으로 보여 줍니다.</p>
                <div style="background-color: #fcf8f2; padding: 12px; border-radius: 8px; margin-bottom: 16px; border-left: 4px solid var(--accent-coral);">
                ...
                <table class="ws-table">
                    ...
                    <tr>
                        ...
                        <td>
                            <textarea style="height: 60px;" placeholder="《${book.title}》의 줄거리를 근거로, 두 낱말이 왜 서로 이어지는지 설명해 보세요..."></textarea>
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td>
                            <textarea style="height: 60px;" placeholder="두 낱말이 인물의 마음이 달라지거나 갈등이 풀리는 데 어떤 몫을 했는지, 책의 장면을 들어 적으세요..."></textarea>
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td>
                            <textarea style="height: 60px;" placeholder="이야기 전체를 꿰뚫는 연결 고리를 책 속 구절이나 결말을 인용해 적으세요..."></textarea>
                        </td>
                    </tr>
                </table>
            </div>
            <div class="ws-section">
                ...
                <textarea class="ws-textarea-box" style="min-height: 90px;" placeholder="낱말들을 모두 이어 본 뒤, 《${book.title}》이 우리에게 하고 싶은 말이 무엇인지 정리해 보세요..."></textarea>
            </div>
        `;
    }
...
function getDynamicScenario(book, tech) {
    ...
    const introTemplates = {
        "panorama": `오늘은 《${book.title}》의 갈등을 주인공의 눈으로만 보지 않습니다. 세 명이 한 모둠이 되어 서로 다른 자리를 하나씩 맡고, 내가 맡은 자리에서 이 일이 어떻게 보이는지 이야기해 봅시다.`,
        "valuebar": `《${book.title}》의 논제 "${mainTopic}"에 내가 얼마나 동의하는지 눈금 위에 표시해 봅시다. 0은 전혀 아니다, 10은 정말 그렇다입니다. 나는 어디에 서고 싶나요?`,
        "brainwriting": `《${book.title}》 속 인물의 어려운 처지를 풀어 줄 조언을 찾습니다. 말하지 않고 종이에 적어 옆으로 넘기며, 친구 생각에 내 생각을 보태 완성해 봅시다.`,
        "procon": `《${book.title}》의 논제 "${mainTopic}"을 두고 찬성과 반대를 번갈아 맡아 봅니다. 내 생각과 반대되는 쪽의 말도 직접 세워 보는 토론입니다.`,
        "hotseating": `《${book.title}》의 주인공을 교실 가운데 '뜨거운 의자'에 모셨습니다. 속마음과 갈등의 까닭을 묻고, 그 답을 들으며 인물을 깊이 이해해 봅시다.`,
        "carousel": `안쪽 원과 바깥쪽 원으로 마주 앉아 《${book.title}》을 두고 짝과 짧게 토론합니다. 시간이 되면 한 칸씩 옮겨 새 짝을 만나고, 앞서 들은 이야기를 보태 가며 이어 갑시다.`,
        "socratic": `《${book.title}》이 우리에게 무엇을 말하는지 함께 찾아가는 시간입니다. 정답을 맞혀 이기는 것이 아니라, 책 뒤에 숨은 뜻을 같이 헤아려 봅시다.`,
        "worldcafe": `테이블마다 《${book.title}》에 대한 다른 질문을 놓았습니다. 카페처럼 편하게 이야기하다가, 자리 주인만 남고 나머지는 다른 테이블로 옮겨 생각을 섞어 봅시다.`,
        "argumentgame": `《${book.title}》에서 나온 주장에 알맞은 까닭과 책 속 근거를 짝지어 붙이는 놀이입니다. 놀면서 말의 뼈대를 튼튼하게 만들어 봅시다.`,
        "doublepyramid": `《${book.title}》의 논제 "${mainTopic}"을 두고, 찬성 쪽과 반대 쪽이 혼자에서 둘로, 둘에서 넷으로 의견을 좁혀 갑니다. 마지막에 두 대표 의견을 마주 놓고 함께 살 길을 찾아봅시다.`,
        "angeldevil": `《${book.title}》 속 주인공의 고민을 두고, 한쪽은 착한 마음을 말하는 천사가, 한쪽은 솔직한 욕심을 말하는 악마가 되어 귓가에서 번갈아 설득해 봅시다.`,
        "hexadebate": `《${book.title}》에서 떠오른 낱말을 육각형 카드에 적고, 이어진다고 생각하는 카드끼리 붙여 갑니다. 다툼의 원인과 풀어 갈 길이 한 장의 그림으로 드러날 거예요.`,
        "trafficlight": `《${book.title}》 속 인물의 선택에 대해 초록·빨강·노랑 카드를 들어 지금 생각을 보여 줍니다. 친구 말을 듣고 카드 색이 바뀌었는지 함께 살펴봅시다.`,
        "pmi": `《${book.title}》 속 결정을 좋은 점(P), 아쉬운 점(M), 흥미로운 점(I) 세 칸으로 나눠 차례대로 살펴본 뒤, 더 나은 방법을 찾아봅시다.`,
        "2stay2stray": `《${book.title}》에 대한 모둠 생각을 정리한 뒤, 두 명은 자리에 남아 설명하고 두 명은 다른 모둠을 찾아다니며 들어 옵니다. 돌아와 둘을 합쳐 마무리합시다.`,
        "fan": `앞사람 말을 한 줄로 요약한 뒤에만 내 생각을 보탤 수 있습니다. 선풍기 날개가 돌듯 차례를 돌리며 《${book.title}》의 해결책을 겹겹이 쌓아 봅시다.`,
        "reasoning": `《${book.title}》의 주인공은 왜 그런 뜻밖의 선택을 했을까요? 숨은 마음을 헤아리고, 그렇게 볼 수 있는 단서를 글과 그림에서 찾아 밝혀 봅시다.`,
        "havruta": `짝과 마주 앉아 《${book.title}》을 두고 '왜?', '정말 그럴까?'를 끝없이 주고받습니다. 묻고 되묻는 사이에 생각이 얼마나 깊어지는지 겪어 봅시다.`
    };

    const wrapUpTemplates = {
        "panorama": `세 자리에서 나란히 보니, 주인공 한 사람만 보았을 때는 보이지 않던 사정이 드러났습니다. 우리 둘레에서도 소리 내지 못하는 쪽의 자리에 서 보는 눈을 길러 갑시다.`,
        "valuebar": `우리 생각이 찬성 아니면 반대로만 갈리지 않고, 그 사이 여러 자리에 고르게 퍼져 있다는 것을 보았습니다. 서로의 말을 듣고 자리를 옮겨 보는 일, 거기서 합의가 시작됩니다.`,
        "brainwriting": `종이를 돌려 가며 생각을 겹겹이 쌓은 끝에, 혼자서는 떠올리지 못했을 해결책이 나왔습니다. 여럿의 머리가 모이면 이만큼 멀리 갈 수 있습니다.`,
        "procon": `찬성과 반대를 모두 말해 보니, 반대쪽에도 그럴 만한 까닭이 있다는 것을 알게 되었습니다. 한쪽만 옳다고 보지 않는 넓은 눈을 오늘 길렀습니다.`,
        "hotseating": `겉으로 드러나지 않던 주인공의 외로움과 고민을 가까이에서 들었습니다. 우리 곁에도 그런 마음이 있다면 어떻게 도울 수 있을지 함께 적어 봅시다.`,
        "carousel": `짝을 바꿔 가며 같은 말을 되풀이하는 동안 내 주장의 빈 곳이 채워지고 근거가 늘었습니다. 오늘 다듬어진 생각을 마지막으로 한 번 더 정리해 봅시다.`,
        "socratic": `이기고 지는 것 없이도 이야기가 이만큼 깊어질 수 있다는 것을 확인했습니다. 끝까지 듣고 그 말에 이어 묻는 대화를 교실 밖에서도 이어 갑시다.`,
        "worldcafe": `테이블을 옮겨 다니며 생각을 흩뿌리고 다시 모은 끝에, 한자리에 머물렀다면 나오지 않았을 결론이 만들어졌습니다. 편하게 나눈 말이 새로운 길을 엽니다.`,
        "argumentgame": `주장에 까닭과 책 속 근거를 짝지어 붙이며 말의 세 마디를 몸에 익혔습니다. 앞으로 글을 쓰거나 의견을 낼 때도 이 차례를 그대로 써 보세요.`,
        "doublepyramid": `양쪽에서 뽑은 가장 좋은 안을 마주 놓고 이야기한 끝에, 두 편이 지키려던 것을 모두 살리는 새로운 답을 만들어 냈습니다.`,
        "angeldevil": `천사와 악마의 말을 고루 들어 보며, 한 사람의 마음속에 서로 다른 생각이 함께 있다는 것을 알게 되었습니다. 그 둘을 다 듣고 스스로 정하는 연습을 했습니다.`,
        "hexadebate": `카드가 이어져 커다란 벌집 모양이 되는 것을 보았습니다. 문제의 한 조각이 아니라 원인과 결과가 얽힌 전체 모습을 보는 눈을 길렀습니다.`,
        "trafficlight": `친구의 말을 듣고 카드 색을 바꿔 보았습니다. 생각이 바뀌는 것은 지는 일이 아니라 잘 들었다는 뜻입니다. 그 열린 마음이 오늘의 가장 큰 배움입니다.`,
        "pmi": `좋은 점과 아쉬운 점에 흥미로운 점까지 고루 살피며 한쪽으로 치우치지 않는 눈을 세웠습니다. 아쉬운 점을 줄일 나만의 방법을 계속 다듬어 가세요.`,
        "2stay2stray": `우리 생각을 남에게 설명하고 다른 모둠의 생각을 받아 오면서, 배움이 한자리에 고이지 않고 돌며 자란다는 것을 겪었습니다.`,
        "fan": `앞사람 말을 정확히 요약해야만 내 말을 얹을 수 있었기에, 제대로 듣는 법을 몸에 익혔습니다. 잘 들은 위에 쌓인 생각은 언제나 단단합니다.`,
        "reasoning": `책 속 문장과 그림의 색, 인물의 표정까지 꼼꼼히 찾아 근거로 삼았습니다. 깊이 읽는 힘이 토론의 수준을 그만큼 끌어올렸습니다.`,
        "havruta": `서로 눈을 마주 보고 묻고 되물으며 생각이 깊어졌습니다. 배움은 정답을 외우는 데 있지 않고 좋은 질문을 만들어 내는 데 있다는 것을 기억합시다.`
    };

    const dialogTemplates = {
        "panorama": [
            { "role": `다른 자리를 맡은 친구`, "text": `나는 《${book.title}》 속 주인공의 선택을 옆에서 꼼꼼히 보았습니다. 주인공이 "${mainTopic}"에 관해 일방적인 결정을 내렸을 때, 주변인으로서 겪었던 현실적인 걱정과 고충은 아무도 알아주지 않아 억울했습니다.` },
