...
const debateTopicsDB = [
    ...
    { type: "value", field: "감정", level: "초등·중학", claim: "화를 참는 것이 좋은 것이다.",
      background: "화를 누르는 일과 드러내는 일 사이에서 무엇이 나은지 묻습니다.",
      pro: ["참으면 상대에게 상처 주는 말을 하지 않는다.", "잠시 기다리면 마음이 가라앉는다."],
      con: ["쌓아 두면 더 크게 터진다.", "화가 났다고 말해야 상대가 알 수 있다."],
      books: ["으르렁 이발소", "괜찮아"] },
