...
const debateTopicsDB = [
    ...
    { type: "policy", field: "교육", level: "중학·고등", claim: "학교 과제에 생성형 AI 사용을 허용해야 한다.",
      background: "AI로 글을 쓰고 자료를 정리하는 일이 일상이 되면서, 학교에서 이를 금지할지 가르칠지를 두고 논의가 이어집니다.",
      pro: ["앞으로 반드시 쓰게 될 도구라면 학교에서 바르게 배워야 한다.", "금지해도 실제로 막을 방법이 없다."],
      con: ["스스로 생각하고 쓰는 힘을 기를 기회를 잃는다.", "누가 실제로 했는지 평가할 수 없다."],
      books: [] },
    ...
    { type: "policy", field: "교육", level: "초등·중학", claim: "학교 수업에 태블릿 등 스마트기기를 전면 도입해야 한다.",
      background: "디지털 교과서 도입이 추진되면서 학습 효과와 부작용을 두고 의견이 갈립니다. 문해력 저하와 집중력 문제를 우려하는 목소리도 큽니다.",
      pro: ["개인 수준에 맞춘 학습이 가능하다.", "디지털 활용 능력은 필수 역량이다."],
      con: ["종이로 읽고 쓰는 경험이 줄어든다.", "기기 관리와 딴짓 문제를 통제하기 어렵다."],
      books: [] },
    ...
    { type: "policy", field: "교육", level: "중학·고등", claim: "학교가 학생의 휴대전화를 일괄 수거하는 것을 금지해야 한다.",
      background: "국가인권위원회는 일괄 수거를 인권 침해로 판단한 사례가 있는 한편, 학습권 보호를 위해 필요하다는 학교 현장의 목소리도 있습니다.",
      pro: ["개인 소유물을 강제로 걷는 것은 권리 침해다.", "스스로 조절하는 법을 배워야 한다."],
      con: ["수업 집중과 다른 학생의 학습권을 지켜야 한다.", "학교 안 촬영·유포 문제를 예방한다."],
      books: [] },

    { type: "policy", field: "교육", level: "중학·고등", claim: "중·고등학교 시험을 절대평가로 전면 전환해야 한다.",
      background: "상대평가는 등수를, 절대평가는 도달 수준을 봅니다. 경쟁 완화와 변별력 사이에서 오랜 논쟁이 이어져 왔습니다.",
      pro: ["과도한 경쟁과 서열화를 줄인다.", "무엇을 얼마나 배웠는지에 집중하게 한다."],
      con: ["성적이 몰려 변별이 어려워진다.", "평가의 신뢰성 확보가 쉽지 않다."],
      books: ["꽃들에게 희망을"] },

    { type: "policy", field: "생명", level: "중학·고등", claim: "학교 급식에서 채식 선택권을 보장해야 한다.",
      background: "동물권·환경·건강 등을 이유로 채식을 택하는 학생이 늘면서, 급식에서 선택지를 마련하는 학교가 생기고 있습니다.",
      pro: ["신념에 따른 식생활도 존중받아야 한다.", "축산은 온실가스 배출 비중이 크다."],
      con: ["조리 인력과 예산 부담이 크다.", "성장기 영양 균형을 세심히 관리해야 한다."],
      books: ["꽃을 선물할게"] },
    ...
    { type: "policy", field: "인권", level: "중학·고등", claim: "학교 폭력 가해 기록을 대학 입시에 반영해야 한다.",
      background: "학교폭력 조치 사항을 입시에 반영하는 제도가 확대됐습니다. 교육적 효과와 낙인 문제가 함께 논의됩니다.",
      pro: ["행동에 책임이 따른다는 것을 분명히 한다.", "피해자 보호에 대한 사회적 신호가 된다."],
      con: ["청소년기의 잘못이 평생 낙인이 될 수 있다.", "교육과 회복이 우선되어야 한다."],
      books: ["내 탓이 아니야"] },
    ...
    // ───────── 추가 정책 논제 · 초등·중학 (학교와 생활 속 문제) ─────────
    { type: "policy", field: "교육", level: "초등·중학", claim: "초등학교에서 숙제를 없애야 한다.",
      background: "핀란드 등 숙제를 거의 내지 않는 나라가 알려지면서 논의가 시작됐습니다. 스스로 공부하는 습관을 어떻게 기를지가 핵심입니다.",
      pro: ["방과 후 시간은 쉬고 놀며 자라는 데 써야 한다.", "숙제를 도와줄 어른이 있는 아이와 없는 아이의 차이가 커진다."],
      con: ["배운 것을 스스로 익히는 시간이 필요하다.", "공부 습관은 반복에서 만들어진다."],
      books: ["지각대장 존"] },

    { type: "policy", field: "교육", level: "초등·중학", claim: "학급 임원은 선거 대신 추첨으로 뽑아야 한다.",
      background: "고대 아테네는 여러 공직을 추첨으로 뽑았습니다. 선거는 뽑을 사람을 고르는 방식이고, 추첨은 누구에게나 같은 기회를 주는 방식입니다.",
      pro: ["인기가 아니라 누구에게나 기회가 돌아간다.", "평소 나서지 못하던 친구도 경험할 수 있다."],
      con: ["맡을 준비가 안 된 사람이 될 수 있다.", "책임지고 일할 사람을 고르는 것이 대표의 뜻이다."],
      books: ["프레드릭"] },

    { type: "policy", field: "안전", level: "초등·중학", claim: "학교 안에 CCTV를 더 많이 설치해야 한다.",
      background: "학교폭력과 안전사고를 막기 위해 CCTV를 늘리자는 요구가 있는 한편, 감시받는 느낌에 대한 우려도 있습니다.",
      pro: ["사고가 났을 때 사실을 정확히 확인할 수 있다.", "설치만으로도 예방 효과가 있다."],
      con: ["늘 감시받으면 학교가 편한 공간이 아니게 된다.", "카메라가 없는 곳으로 옮겨 갈 뿐이다."],
      books: ["내 탓이 아니야"] },

    { type: "policy", field: "환경", level: "초등·중학", claim: "급식을 남기면 벌점을 주어야 한다.",
      background: "학교 급식에서 나오는 잔반은 처리 비용과 온실가스를 함께 만듭니다. 한편 먹는 양과 취향은 저마다 다릅니다.",
      pro: ["음식을 남기는 것은 자원 낭비다.", "규칙이 있어야 실제로 줄어든다."],
      con: ["몸 상태와 식사량은 사람마다 다르다.", "억지로 먹게 하면 급식이 두려운 시간이 된다."],
      books: ["플라스틱 섬"] },

    { type: "policy", field: "생명", level: "초등·중학", claim: "학교에서 동물을 기르지 않아야 한다.",
      background: "교실에서 햄스터나 물고기를 기르는 학교가 있습니다. 생명을 가까이서 배우는 기회이자, 방학 중 돌봄 문제가 함께 생깁니다.",
      pro: ["방학과 주말에 제대로 돌보기 어렵다.", "생명을 교육 도구로 쓰는 것은 옳지 않다."],
      con: ["직접 돌보며 생명 존중을 배운다.", "책으로만 배우는 것과 다르다."],
      books: ["나는 기다립니다", "우리, 집"] },

    { type: "policy", field: "교육", level: "초등·중학", claim: "학교 운동회에서 등수를 매기지 않아야 한다.",
      background: "모두가 참여하는 운동회를 만들기 위해 순위를 없앤 학교가 늘고 있습니다.",
      pro: ["잘 못하는 아이에게 운동회가 괴로운 날이 된다.", "함께 즐기는 것이 운동회의 목적이다."],
      con: ["최선을 다할 이유가 사라진다.", "이기고 지는 경험도 배움이다."],
      books: ["슈퍼 거북", "토끼와 거북이, 두 번째 경주"] },

    { type: "policy", field: "교육", level: "초등·중학", claim: "모둠 활동 점수는 개인별로 다르게 주어야 한다.",
      background: "모둠 과제에서 한두 사람만 열심히 하는 '무임승차' 문제는 어느 교실에나 있습니다.",
      pro: ["한 만큼 받는 것이 공정하다.", "아무것도 안 해도 같은 점수면 열심히 할 이유가 없다."],
      con: ["함께 해내는 법을 배우는 것이 모둠 활동의 목적이다.", "누가 얼마나 했는지 정확히 나눌 수 없다."],
      books: ["돌멩이 국", "돼지책"] },
    ...
    { type: "policy", field: "문화", level: "초등·중학", claim: "학교 도서관은 인기 있는 책을 더 많이 사야 한다.",
      background: "한정된 예산으로 어떤 책을 살지는 늘 고민입니다. 많이 읽히는 책과 읽혔으면 하는 책 사이의 선택입니다.",
      pro: ["읽고 싶은 책이 있어야 도서관에 온다.", "읽는 즐거움이 먼저다."],
      con: ["도서관은 다양한 책을 만나는 곳이어야 한다.", "인기만 따르면 좋은 책이 사라진다."],
      books: ["행복한 청소부", "프레드릭"] },
    ...
    { type: "policy", field: "교육", level: "고등", claim: "대학 입시에서 지역 균형 선발을 확대해야 한다.",
      background: "지역과 학교에 따라 교육 여건 차이가 큽니다. 균형 선발은 이를 보정하려는 제도입니다.",
      pro: ["출발선의 차이를 보정하는 것이 공정이다.", "지역 인재가 지역에 남는 효과가 있다."],
      con: ["같은 점수인데 지역으로 갈리는 것은 역차별이다.", "근본적으로는 지역 교육 여건을 개선해야 한다."],
      books: ["완벽한 아이 팔아요"] },
    ...
    { type: "policy", field: "인권", level: "고등", claim: "교사에게도 정치적 의사 표현의 자유를 폭넓게 허용해야 한다.",
      background: "교사의 정치적 중립 의무와 시민으로서의 표현의 자유가 부딪치는 문제입니다.",
      pro: ["교사도 시민으로서 권리를 가진다.", "중립을 이유로 침묵을 강요할 수 없다."],
      con: ["학생이 영향을 받을 수 있다.", "교실의 정치적 중립은 지켜져야 한다."],
      books: ["지각대장 존"] },
